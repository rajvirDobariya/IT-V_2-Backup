...
@RestController
@RequestMapping("/counterfeit/denomination")
public class DenominationControllerEncy {

	Logger LOG = LoggerFactory.getLogger(DenominationControllerEncy.class);
	...
	public ResponseEntity<Object> getDenominationByCounterfeitId(@RequestBody String requestString,
		...
		JSONObject responseJson = denominationService.getDenominations(requestString, channel, X_Session_ID,
				X_encode_ID, request, false, true);
		// Encrypt Response

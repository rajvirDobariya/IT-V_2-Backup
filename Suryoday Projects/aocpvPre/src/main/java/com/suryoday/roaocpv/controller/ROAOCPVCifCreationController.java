...
public class ROAOCPVCifCreationController {
	...
	public ResponseEntity<Object> dedupeCall(@RequestBody String bm,
		...
		ResponseEntity<Object> fetchByApplicationPDF = detailsController.fetchByApplicationPDF(bm,headerPersist,X_From_ID,X_To_ID,X_Transaction_ID,X_User_ID,X_Request_ID,req,res);

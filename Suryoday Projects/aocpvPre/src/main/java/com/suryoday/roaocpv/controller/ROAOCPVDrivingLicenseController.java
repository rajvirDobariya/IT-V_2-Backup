...
public class ROAOCPVDrivingLicenseController {
	...
	private static Logger logger = LoggerFactory.getLogger(ROAOCPVDrivingLicenseController.class);
...
//			JSONObject authenticateDrivingLicense = drivinglicenseservice.authenticateDrivingLicense(drivingLicenseNo, Header);

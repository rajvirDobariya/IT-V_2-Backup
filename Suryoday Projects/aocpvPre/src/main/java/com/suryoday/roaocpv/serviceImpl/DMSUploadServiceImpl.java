...
public class DMSUploadServiceImpl implements DMSUploadService {
	...
	public JSONObject dmsupload(JSONObject jsonobject) throws IOException {
		...
		String appNo=jsonobject.getJSONObject("Data").getString("ApplicationNo");
		long applicationNO=Long.parseLong(appNo);
		JSONObject request=GenrateDmsRequest(applicationNO);
		URL obj = null;
		try {
    ...
    private JSONObject GenrateDmsRequest(long applicationNO) {
...
//		Optional<AocpvImages> byApplicationNoAndName = imagerepo.getByApplicationNoAndName(applicationNO,"CUST_1_PHOTOGRAPH");

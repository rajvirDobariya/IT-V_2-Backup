...
public class ROAOCPVPassportController {
	...
	private static Logger logger = LoggerFactory.getLogger(ROAOCPVPassportController.class);
...
//			JSONObject verifyPassport = passportservice.verifyPassport(passportNo,doi,Header);
			JSONObject verifyPassport = passportservice.verifyPassport2(passportNo,doi);

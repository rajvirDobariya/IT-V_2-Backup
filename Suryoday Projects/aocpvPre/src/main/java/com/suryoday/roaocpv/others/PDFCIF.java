...
public class PDFCIF {
	...
	public byte[] exportPDFCIF(HttpServletResponse res) throws  Exception {
       ...
       //  Image image = Image.getInstance("C:\\Users\\Neosoft\\Documents\\UAT\\aocpvUat\\src\\main\\resources\\static\\logo.jpg");
       //  Image image=null;
       ...
       document.add((Element) Image.getInstance(imageCustomer));
         ...
         document.add( Chunk.NEWLINE );
         // customer photo 
         Image imageCustomer1 = Image.getInstance(imageCustomer);
         imageCustomer1.scaleToFit(150,220);
         imageCustomer1.setAbsolutePosition(410,450);
...
//         instance.setAlignment(100);
	     ...
	     String title = " Application Reference Number            "+list1.get(0)+"                             Customer ID        "+list1.get(1);
	     ...
	     String line23 = " Permnanent Address                                          "+list1.get(17)+" , "+list1.get(18)+" , "+list1.get(19)+" , "+list1.get(20)+" , "+list1.get(21)+" , "+list1.get(22)+" , "+list1.get(23)+" , "+list1.get(24)+" , "+list1.get(25)+" ";
	     String line24 = " Current Address                                                  "+list1.get(27)+" , "+list1.get(28)+" , "+list1.get(29)+" , "+list1.get(30)+" , "+list1.get(31)+" , "+list1.get(32)+" , "+list1.get(33)+" , "+list1.get(34)+" , "+list1.get(35)+" ";
	     String line25 = " Office Address                                                     "+list1.get(37)+" , "+list1.get(38)+" , "+list1.get(39)+" , "+list1.get(40)+" , "+list1.get(41)+" , "+list1.get(42)+" , "+list1.get(43)+" , "+list1.get(44)+" , "+list1.get(45)+" ";
	     ...
	     String line63 = " "+day+", "+now+"                                         CIF_Form                                                          2";
	     ...
	     document.add(new Paragraph("____________________________________________________________________________________________",font2));
	     document.add( Chunk.NEWLINE );
	     document.add(new Paragraph("I/We am/are not citizen / national / tax resident of any other country than India. ",font2));
	     document.add( Chunk.NEWLINE );
	     document.add(new Paragraph("____________________________________________________________________________________________",font2));

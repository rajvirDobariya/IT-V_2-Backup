...
public class ClientCreationController {
	...
	@RequestMapping(value="/zipCodeMaster", method = RequestMethod.POST,produces = "application/json")
	...
	@RequestMapping(value="/cityMaster", method = RequestMethod.POST,produces = "application/json")
	...
	@RequestMapping(value="/stateMaster", method = RequestMethod.POST,produces = "application/json")
	...
	@RequestMapping(value="/districtMaster", method = RequestMethod.POST,produces = "application/json")
	...
	@RequestMapping(value="/subDistrictMaster", method = RequestMethod.POST,produces = "application/json")
	...
	@RequestMapping(value="/occupationMaster", method = RequestMethod.POST,produces = "application/json")

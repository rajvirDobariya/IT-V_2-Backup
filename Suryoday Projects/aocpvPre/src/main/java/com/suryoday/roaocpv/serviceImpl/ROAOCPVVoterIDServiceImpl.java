...
@Service
public class ROAOCPVVoterIDServiceImpl implements ROAOCPVVoterIDService {

	private static Logger logger = LoggerFactory.getLogger(ROAOCPVVoterIDServiceImpl.class);
	...
	public JSONObject voterID(JSONObject jSONObject, JSONObject header) {
		...
		try {
			...
			logger.debug(x.BASEURL + "karza/voterId?api_key=" + x.api_key);
			obj = new URL(x.BASEURL + "karza/voterId?api_key=" + x.api_key);

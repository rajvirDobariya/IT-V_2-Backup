...
public class CustomerDataServiceImpl implements CustomerDataService{
	...
	public String saveFamilyMember(FamilyMember familyMember) {
		int id=1;
		Optional<FamilyMember> optional=familyMemberRepository.fetchByCustomerIdAndMember(familyMember.getCustomerId(),familyMember.getMember());
		if(optional.isPresent()) {
	...
	public List<FamilyMemberResponse> fetchFamilyMember(String customerId) {
		...
		for(FamilyMember familyMember:list) {
			...
			List<FamilyMemberImages> imageList = imageRepository.getByCustomerIdMember(customerId, familyMember.getMember());

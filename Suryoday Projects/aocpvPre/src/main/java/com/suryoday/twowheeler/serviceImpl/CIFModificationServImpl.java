...
@Component
public class CIFModificationServImpl implements CIFModificationService{
	private static Logger logger = LoggerFactory.getLogger(CIFModificationServImpl.class);
	@Override
	public JSONObject crmModification(JSONObject jsonObject, JSONObject header) {
		...
		try {
			...
			HttpsURLConnection.setDefaultHostnameVerifier(allHostsValid);
			 obj = new URL(x.BASEURL+"customer/220160798/modify/v2?api_key="+x.api_key);
				logger.debug(x.BASEURL+"customer/220160798/modify/v2?api_key="+x.api_key);;

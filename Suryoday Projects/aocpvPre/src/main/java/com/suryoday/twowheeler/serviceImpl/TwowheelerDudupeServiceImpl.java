...
public class TwowheelerDudupeServiceImpl implements TwowheelerDudupeService{
	...
	public JSONObject dedupeCall(JSONObject jsonObject, JSONObject header) {
		...
		String referenceNo = twowheelerDetailesTable.getAadharNo();
		String panCard = twowheelerDetailesTable.getPancard();
		String voterId = twowheelerDetailesTable.getVoterId();

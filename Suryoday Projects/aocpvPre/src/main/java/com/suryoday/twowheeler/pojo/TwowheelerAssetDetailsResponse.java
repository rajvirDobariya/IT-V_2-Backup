...
public class TwowheelerAssetDetailsResponse {
	...
	private String totalOnRoadPriceUser;
	...
	public String getTotalOnRoadPriceUser() {
		return totalOnRoadPriceUser;
	}
	public void setTotalOnRoadPriceUser(String totalOnRoadPriceUser) {
		this.totalOnRoadPriceUser = totalOnRoadPriceUser;
	}

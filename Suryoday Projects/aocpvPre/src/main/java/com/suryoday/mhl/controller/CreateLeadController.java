...
public class CreateLeadController {
	...
	Logger logger = LoggerFactory.getLogger(CreateLeadController.class);
	
	@RequestMapping(value="/createLead/saveData", method = RequestMethod.POST)
	...
	@RequestMapping(value="/createLead/fetchByBranchIdAndstatus", method = RequestMethod.POST)
	public ResponseEntity<Object> fetchByBranchIdAndstatus(@RequestBody String jsonRequest ,
		...
		org.json.simple.JSONObject  response= new org.json.simple.JSONObject();
		response.put("status", HttpStatus.OK.toString());
		response.put("Data", createLeads);
		logger.debug("final response"+response.toString());
		return new ResponseEntity<Object>(response,HttpStatus.OK);
	
	}
	
	@RequestMapping(value="/createLead/fetchByDate", method = RequestMethod.POST)
		 ...
		 logger.debug("db Call start");
		 	...
		 	if(status.isEmpty()  && branchId.isEmpty()) {
				...
				return new ResponseEntity<Object>(response,HttpStatus.OK);
		 		...
		 		org.json.simple.JSONObject  response= new org.json.simple.JSONObject();
				response.put("status", HttpStatus.OK.toString());
				response.put("Data", listWithoutStatus);
				...
				return new ResponseEntity<Object>(response,HttpStatus.OK);
		 		...
		 		org.json.simple.JSONObject  response= new org.json.simple.JSONObject();
				response.put("status", HttpStatus.OK.toString());
				response.put("Data", listWithoutBranchId);
				...
				return new ResponseEntity<Object>(response,HttpStatus.OK);
		 		...
		 		for(CreateLead createLead : list) {
		 			if(createLead.getStatus().equalsIgnoreCase(status) && createLead.getBranchId().equalsIgnoreCase(branchId)) {
		 				listWithBranchIdAndStatus.add(createLead);
		 			}
		 		}
		 		org.json.simple.JSONObject  response= new org.json.simple.JSONObject();
				response.put("status", HttpStatus.OK.toString());
				response.put("Data", listWithBranchIdAndStatus);
	...
	// Save Income Details
		...
		@RequestMapping(value="/incomeDetails/saveData", method = RequestMethod.POST)
		public ResponseEntity<Object> saveIncomelDetailsData(@RequestBody String jsonRequest ,
			...
			System.out.println("JSON STRING "+jsonObject);
				...
				String intersetedInPropertyInsurance = jsonObject.getJSONObject("Data").getString("intersetedInPropertyInsurance");

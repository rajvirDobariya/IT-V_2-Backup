...
public class PDFDisbursmentLetter {
	...
	public void export(HttpServletResponse response) throws Exception {
       ...
       document.add(new Paragraph("                                                                               Date: 2022-09-08 Place: CHAMARAJNAGAR"));
       document.add( Chunk.NEWLINE );
       document.add(new Paragraph("Customer Name:  ………………………………                   Loan A/c No:         "));
       document.add(new Paragraph("Property address:  PROPERTY NO. UNIQUE NO.150800101800120203,IRASAVADI VILLAGE & GRAMAPANCHAYATH, CHMARAJANAGAR TALUK & DISTRICT. "));      
       document.add(new Paragraph("City - CHAMARAJNAGAR  State: KARNATAKA  Pin code: 571441"));
       document.add(new Paragraph("Mobile Number:  7760912330         Registered Email ID:  ___________________________"));
       
       document.add(new Paragraph("Disbursement Details:"));
       document.add( Chunk.NEWLINE );
       document.add(new Paragraph(titles.get(2)+" 650000"));
       document.add( Chunk.NEWLINE );
       document.add(new Paragraph("Date of registration (Agreement to sale/sale deed/Equitable mortgage deed/Registered Mortgage deed) - …………….\r\n"
       		+ "       \r\n"
       ...
       document.add(new Paragraph("_______________________    _______________________     _________________________  "));
       document.add(new Paragraph(" Applicant/POA holder      Co-applicant 1/POA holder   Co-Applicant 2/POA Holder "));

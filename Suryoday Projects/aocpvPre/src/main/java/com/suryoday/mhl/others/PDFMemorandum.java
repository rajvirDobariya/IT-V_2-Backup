...
public class PDFMemorandum {
	...
	public void export(HttpServletResponse response) throws Exception {
       ...
       table.addCell(new Phrase("   PROPERTY NO. UNIQUE NO.150800101800120203,IRASAVADI VILLAGE & GRAMAPANCHAYATH, CHMARAJANAGAR TALUK & DISTRICT."));
       ...
       table2.addCell(new Phrase("DEMAND REGISTER EXTRACT ISSUED BY THE PDO, ERASAVADI GRAMA PANCHAYATH STANDS IN THE NAME OF CO-APPLICANT SMT.MANIYAMMA W/O LATE.KAMASHETTY ."));      
       table2.addCell(new Phrase("   01-07-2006"));
       table2.addCell(new Phrase("   2 "));
       table2.addCell(new Phrase("E-KHATHA EXTRACT FORM NO:- 9 & 11A VIDE BEARING E-KATHA NO -150800101800120203                 ISSUED BY PDO ERASAVADI  GRAMA PANCHAYATH IN FAVOUR OF THE CO-APPLICANT SMT.MANIYAMMA W/O KAMASHETTY ."));      
       table2.addCell(new Phrase("   07-09-2022"));
       table2.addCell(new Phrase("   3 "));
       table2.addCell(new Phrase("TAX PAID RECEIPT ISSUED BY ERASAVADI GRAMA PANCHAYATH, WITH RESPECT TO THE PROPOSED  PROPERTY ."));      
       ...
       table2.addCell(new Phrase("ENCUMBRANCE CERTIFICATE ISSUED BY THE SR OF KUDERU  FROM THE YEAR 01-04-2004  TO 12-09-2022 ."));      
       table2.addCell(new Phrase("   13-09-2022"));
       table2.addCell(new Phrase("   1 "));
       table2.addCell(new Phrase("DEMAND REGISTER EXTRACT ISSUED BY THE PDO, ERASAVADI GRAMA PANCHAYATH STANDS IN THE NAME OF CO-APPLICANT SMT.MANIYAMMA W/O LATE.KAMASHETTY ."));      
       table2.addCell(new Phrase("   01-07-2006"));
       ...
       document.add(p4);
       document.add(new Paragraph("\n"));
       document.add(new Paragraph("All those pieces of land comprised in the survey numbers specified below, within the limits of the villages, district and state specified below.",font));
       document.add(new Paragraph("\n"));

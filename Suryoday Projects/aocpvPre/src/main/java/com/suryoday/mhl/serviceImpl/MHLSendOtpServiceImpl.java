	...
	public JSONObject sendOtp(JSONObject jSONObject, JSONObject header) {
		...
		try {
			...
			HttpsURLConnection.setDefaultHostnameVerifier(allHostsValid); 
			 ...
			 obj =new URL("https://intramashery.suryodaybank.co.in/notification/otp/sms?api_key=kyqak5muymxcrjhc5q57vz9v");
		...
		try {
			...
			// Create all-trusting host name verifier
			 HostnameVerifier allHostsValid = new HostnameVerifier() {
				...
				obj =new URL("https://intramashery.suryodaybank.co.in/transaction/OTP/validate?api_key=kyqak5muymxcrjhc5q57vz9v&OTP="+oTP+"&TransactionType=D");
					HttpURLConnection con = (HttpURLConnection) obj.openConnection();

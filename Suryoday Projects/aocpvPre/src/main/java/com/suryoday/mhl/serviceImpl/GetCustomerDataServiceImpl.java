...
import com.suryoday.mhl.service.GetCustomerDataService;

@Service
public class GetCustomerDataServiceImpl implements GetCustomerDataService {
	

	private static Logger logger = LoggerFactory.getLogger(GetCustomerDataServiceImpl.class);
	...
	public JSONObject getData(JSONObject jSONObject, JSONObject header) {
		...
		try {
			...
			HttpsURLConnection.setDefaultHostnameVerifier(allHostsValid); 
			 ...
			 obj =new URL("http://10.20.25.37:443/aocpv/customer/getData");

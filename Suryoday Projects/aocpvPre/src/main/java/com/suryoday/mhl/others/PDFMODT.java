...
public class PDFMODT {
	...
	public void export(HttpServletResponse response) throws  Exception{
       ...
       document.add( Chunk.NEWLINE );
		 ...
		 document.add(new Paragraph("TALUK & DISTRICT. (hereinafter referred to as “Borrower” or “Depositor”, Which expression shall",font2));
	    ...
	    textUnderline = new Chunk(titles.get(59),font3);
	     ...
	     PdfPTable table = new PdfPTable(new float[] { 10, 20, 50, 20 });
	       ...
	       table.addCell(new Phrase("   DEMAND REGISTER EXTRACT ISSUED BY THE PDO, ERASAVADI GRAMA PANCHAYATH STANDS IN THE NAME OF CO-APPLICANT SMT.MANIYAMMA W/O LATE.KAMASHETTY ."));
	       table.addCell(new Phrase("   CERTIFIED COPY 2 PAGES     "));
	       table.addCell(new Phrase("   2 "));
	       table.addCell(new Phrase("   07-09-2022"));
	       table.addCell(new Phrase("   E-KHATHA EXTRACT FORM NO:- 9 & 11A VIDE BEARING E-KATHA NO -150800101800120203                 ISSUED BY PDO ERASAVADI  GRAMA PANCHAYATH IN FAVOUR OF THE CO-APPLICANT SMT.MANIYAMMA W/O KAMASHETTY."));
	       table.addCell(new Phrase("   COMPUTERIZED  COPY 3 PAGES     "));
	       table.addCell(new Phrase("   3 "));
	       table.addCell(new Phrase("   30-08-2022"));
	       table.addCell(new Phrase("   TAX PAID RECEIPT ISSUED BY ERASAVADI GRAMA PANCHAYATH, WITH RESPECT TO THE PROPOSED  PROPERTY ."));
	       ...
	       table.addCell(new Phrase("   13-09-2022"));
	       table.addCell(new Phrase("   ENCUMBRANCE CERTIFICATE ISSUED BY THE SR OF KUDERU  FROM THE YEAR 01-04-2004  TO 12-09-2022."));
	     ...
	     document.add( Chunk.NEWLINE);
	     document.add(new Paragraph("MANIYAMMA             PROPERTY NO. UNIQUE NO.150800101800120203,IRASAVADI VILLAGE &",font2));
	     ...
	     document.add( Chunk.NEWLINE);
	     document.add(new Paragraph("IN WITNESS WHERE of the Executant/s has/have signed this memorandum on this date - ………………",font2));
	     ...
	     document.add( Chunk.NEWLINE);
	     document.add( Chunk.NEWLINE);
	     document.add(new Paragraph("MANIYAMMA                           PHOTO                                THUMB IMPRESSION"));

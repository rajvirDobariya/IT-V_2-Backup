...
@Service
public class MHLPanCardConsumingServiceImpl implements MHLPanCardConsumingService{

	private static Logger logger = LoggerFactory.getLogger(MHLPanCardConsumingServiceImpl.class);
	...
	public JSONObject panCardValidation(String panCardNo, JSONObject header) {
		...
		try {
			...
			HttpsURLConnection.setDefaultHostnameVerifier(allHostsValid); 
			 ...
			 //obj =new URL("https://surapiuat.suryodaybank.co.in/validate/CBPan?api_key=kyqak5muymxcrjhc5q57vz9v&PanID="+panCardNo);
			 obj = new URL("https://intramashery.suryodaybank.co.in/ssfbuat/validate/CBPan/v2?PanID="+panCardNo+"&api_key=kyqak5muymxcrjhc5q57vz9v");

...
public class MHLCityPinCodeEncyController {

	@Autowired
	private MHLCityPinCodeService mHLCityPincodeService;

	@Autowired
	UserService userService;

	private static Logger logger = LoggerFactory.getLogger(MHLCityPinCodeEncyController.class);
	...
	public ResponseEntity<Object> cityPinCode(
		...
		if (sessionId == true) {
			...
			if (X_Request_ID.equals("IEXCEED")) {
				...
				JSONObject cityPinCode = mHLCityPincodeService.getCityPincode(cityPincode, Header);

...
public class CSVServiceImpl implements CSVService{
	...
	public List<CSVModelResponse> findAllCustomerByDate(String branchId, LocalDate startdate, LocalDate enddate,
		...
		for(CSVModel csv : list) {
			CSVModelResponse  csvModelResponse = new CSVModelResponse(csv.getCustomerName(), csv.getCity(), csv.getCurrentPOS(), csv.getAggrementID(), csv.getCustomerID(), csv.getChasisnum(), csv.getDisbursalDate());

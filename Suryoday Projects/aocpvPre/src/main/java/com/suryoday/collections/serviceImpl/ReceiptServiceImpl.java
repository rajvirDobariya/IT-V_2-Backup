...
public class ReceiptServiceImpl implements ReceiptService{
	...
	public List<ReceiptResponse> findTopReceiptList(String branchId) {
		...
		for(ReceiptPojo receiptpojo: list) {
			...
			ReceiptResponse response=new ReceiptResponse(currentDate1, receiptpojo.getReceiptNo(), receiptpojo.getTotalCount(), receiptpojo.getAccountNo(), receiptpojo.getCustName(), receiptpojo.getPaymanetStatus());
			list1.add(response);
		}
		return list1;
	}

	...
	public JSONObject getReviewData(String applicationNo, String request) {
		...
		if(optional.isPresent()) {
			...
			for(DsaOnboardMember dsaOnboardMember:list) {
				...
				BasicDetails.put("ekycVerify",dsaOnboardMember.getEkycVerify()!=null?dsaOnboardMember.getEkycVerify():"NO");
				...
				BasicDetails.put("nameOnPancard",dsaOnboardMember.getNameOnPanCard()!=null?dsaOnboardMember.getNameOnPanCard():"");
				BasicDetails.put("dobONPancard",dsaOnboardMember.getDobOnPanCard()!=null?dsaOnboardMember.getDobOnPanCard():"");
				dsaOnboardMember.setIsPrimaryMember(dsaOnboardMember.getIsPrimaryMember() != null ? dsaOnboardMember.getIsPrimaryMember():"NO");
...
//					 }
				...
				if(request.equals("web")) {
					List<DsaImage> listOfImage=imageService.getByApplicationNoAndMember(applicationNo,dsaOnboardMember.getMember());
			...
			dsaOnboardDetails.setSendLeegalityVerify(dsaOnboardDetails.getSendLeegalityVerify() !=null ? dsaOnboardDetails.getSendLeegalityVerify():"NO");
			dsaOnboardDetails.setCheckLeegalityVerify(dsaOnboardDetails.getCheckLeegalityVerify() !=null ? dsaOnboardDetails.getCheckLeegalityVerify():"NO");
			...
			bankDetails.put("bankDetailsVerify", dsaOnboardDetails.getBankDetailsVerify()!=null?dsaOnboardDetails.getBankDetailsVerify():"NO");
...
//					 }
				...
				salesManagerFeedbackResponse.put("servicesOffered", salesManagerFeedbackObject.getString("servicesOffered"));
				salesManagerFeedbackResponse.put("recommend", salesManagerFeedbackObject.getString("recommend"));
				salesManagerFeedbackResponse.put("salesManagerRemarks", salesManagerFeedbackObject.getString("salesManagerRemarks"));
				...
				if(dsaOnboardPayoutDetails.getAgencyType() != null) {
					...
					if(dsaOnboardDetails.getCreditOpsFeedback() != null) {
						...
						org.json.JSONArray businessReferenceInArray =new org.json.JSONArray(creditOpsFeedback);
						 ObjectMapper objectMapper = new ObjectMapper();
						 try {
						 List<CreditFeedbackResponse> reference = objectMapper.readValue(creditOpsFeedback, new TypeReference<List<CreditFeedbackResponse>>() {});
...
//		}
	...
	public LoginResponse getRegistrationDetails(String applicationNo) {
		Optional<DsaOnboardDetails> optional=dsaOnBoardDetailsRepository.getByApplicationNo(Long.parseLong(applicationNo));
		if(optional.isPresent()) {
			DsaOnboardDetails dsaOnboardDetails = optional.get();
			...
			if(dsaOnboardDetails.getProductType() != null) {
				 ObjectMapper objectMapper = new ObjectMapper();
				 try {
				 List<String> reference = objectMapper.readValue(dsaOnboardDetails.getProductType(), new TypeReference<List<String>>() {});
		...
		if(optional.isPresent()) {
			...
			if(dsaOnboardDetails.getCfrReport() != null) {
				String cfrReport = dsaOnboardDetails.getCfrReport();
				 ObjectMapper objectMapper = new ObjectMapper();
				 try {
				 List<CfrReportResponse> reference = objectMapper.readValue(cfrReport, new TypeReference<List<CfrReportResponse>>() {});
			...
			if(dsaOnboardDetails.getAmlReport() != null) {
				String amlReport = dsaOnboardDetails.getAmlReport();
				 ObjectMapper objectMapper = new ObjectMapper();
				 try {
				 AmlReportResponse reference = objectMapper.readValue(amlReport, new TypeReference<AmlReportResponse>() {});
	...
	public BankDetailsResponse getBankDetails(String applicationNo) {
		...
		if(optional.isPresent()) {
			...
			bankDetailsResponse.setBankDetailsVerify(dsaOnboardResponse.getBankDetailsVerify()!=null?dsaOnboardResponse.getBankDetailsVerify():"NO");
	...
	public DsaOnboardDetails getByregiCode(String regicode) {
		...
		if(optional.isPresent()) {
			...
			throw new NoSuchElementException("Application number - "+dsaOnboardDetails.getApplicationNo()+" has been registered successfully !!");
		}
		throw new NoSuchElementException("No Record Found");
	}
	@Override

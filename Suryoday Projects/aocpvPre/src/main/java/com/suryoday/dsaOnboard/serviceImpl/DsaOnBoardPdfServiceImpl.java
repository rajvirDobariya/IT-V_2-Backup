...
public class DsaOnBoardPdfServiceImpl implements DsaOnBoardPdfService {
	...
	public String connectorServiceAgreementPdf(StringBuilder htmlString, String applicationNo) {
		...
		String jsonArray = dsaOnboardDetails.getProductType();
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			if (jsonArray.substring(i).equals("HL")) {
				htmlString.append(new String("<h3 style=\"text-align: center;\"><u><b>Home Loan - Connector Pay-out</b></u></h3>\r\n"
						+ "<br>\r\n"
						+ "   <table style=\"margin-left: auto; margin-right: auto;width: 60%;\">\r\n"
						+ "    \r\n"
						+ "    <tr style=\"height: 20px;\">\r\n"
						...
						+ "    \r\n"
						+ "</table><br></br>"));
			} else if (jsonArray.substring(i).equals("CV")) {
				htmlString.append(new String("<h3 style=\"text-align: center;\"><u><b>Commercial Vehicle Loan - Connector/Referral Pay-out</b></u></h3>\r\n"
						+ "<br>\r\n"
						+ "   <table style=\"margin-left: auto; margin-right: auto;width: 60%;\">\r\n"
						+ "    \r\n"
						+ "    <tr style=\"height: 20px;\">\r\n"
			...
			} else if (jsonArray.substring(i).equals("LAP")) {
				htmlString.append(new String("<h3 style=\"text-align: center;\"><u><b>Loan Against Property - Connector Pay-Out</b></u></h3>\r\n"
						+ "<br>\r\n"

...
public class CustomerResponse {
	...
	public CustomerResponse(long mobilePhone, long customerID, String memberName, String dateOfBirth, String address,
			...
			long applicationNo, String updateDate,String listType ,List<RemarkResponse> remark,String appNoWithProductCode,String createdBy) {
		super();
		this.mobilePhone = mobilePhone;
		this.customerID = customerID;
		this.memberName = memberName;
	...
	public CustomerResponse(long mobilePhone, long customerID, String memberName, String branchId, String status,
			String createDate, String updateDate, String listType, String appNoWithProductCode ,
			long applicationNo) {
		super();
		this.mobilePhone = mobilePhone;
		this.customerID = customerID;

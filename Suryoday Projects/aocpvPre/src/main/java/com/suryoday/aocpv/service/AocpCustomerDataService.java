...
public interface AocpCustomerDataService {
	...
	JSONObject calculateEmi(String amountRequested);
	
	List<CustomerWebResponse> getRetriveReportData(String startDate, String endDate, String status, String state, String city, String area);

	List<EmiProductCodeResponse> getEmiProductCodes();
}

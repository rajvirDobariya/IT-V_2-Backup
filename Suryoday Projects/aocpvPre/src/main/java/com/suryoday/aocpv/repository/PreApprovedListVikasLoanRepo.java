...
public interface PreApprovedListVikasLoanRepo extends JpaRepository<PreApprovedListVikasLoan, Long>{
	...
	@Query(value = "SELECT new com.suryoday.aocpv.pojo.LoanDetail(l.mobilePhone, l.referenceNo, l.customerID, l.memberName, l.state, l.branchId, l.amount, l.status, l.createDate, l.productCode, l.obligation) from PreApprovedListVikasLoan l where l.customerID =:customerId")
	Optional<LoanDetail> getByCustomerId(@Param("customerId") long customerId);

	@Query(value = "SELECT new com.suryoday.aocpv.pojo.LoanDetail(l.mobilePhone, l.referenceNo, l.customerID, l.memberName, l.state, l.branchId, l.amount, l.status, l.createDate, l.productCode, l.obligation) from PreApprovedListVikasLoan l where l.mobilePhone =:mobile and l.branchId =:branchid")
	Optional<List<LoanDetail>> getByMobilePhone(long mobile ,long branchid);
	
	@Query(value = "SELECT new com.suryoday.aocpv.pojo.LoanDetail(l.mobilePhone, l.referenceNo, l.customerID, l.memberName, l.state, l.branchId, l.amount, l.status, l.createDate, l.productCode, l.obligation) from PreApprovedListVikasLoan l where l.isActive='1' and l.updatedate between :s and :e and l.branchId =:branch")
	...
	@Query(value = "SELECT a from PreApprovedListVikasLoan a where a.customerID =:customerId and a.branchId =:branchId order by a.updatedate desc")
	Optional<PreApprovedListVikasLoan> fetchByCustomerIdAndBranch(long customerId,long branchId);
	...
	Optional<List<PreApprovedList>> fetchByDate(@Param ("s") LocalDate startdate ,@Param ("e") LocalDate enddate, long branchId1);
	...
	@Query(value = "SELECT a from PreApprovedListVikasLoan a where a.customerID =:customerNo order by a.updatedate desc")
	Optional<PreApprovedListVikasLoan> fetchByCustomerId(long customerNo);
}

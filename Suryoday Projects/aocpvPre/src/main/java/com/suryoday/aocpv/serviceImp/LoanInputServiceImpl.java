...
//		throw new NoSuchElementException("customer not present");
	...
	public List<PreApprovedListVikasLoan> getByStatus(String status) {
		...
		return loanInputRepositery.findByStatus(status)
								  .orElseThrow(()->new NoSuchElementException("list is empty"));
	}
...
//	}
	...
	public PreApprovedListVikasLoan fetchByCustomerID(long customerNo) {
		...
		return  loanInputRepositery.fetchByCustomerId(customerNo)
								   .orElse(null);
	}
...
//				getHeadersRequestInfo(con);
	...
	@Override
	public PreApprovedListVikasLoan fetchByCustomerIdAndBranch(long customerId, long branchIdInLong) {
		return  loanInputRepositery.fetchByCustomerIdAndBranch(customerId,branchIdInLong)
				.orElseThrow(()->new NoSuchElementException("No record found"));

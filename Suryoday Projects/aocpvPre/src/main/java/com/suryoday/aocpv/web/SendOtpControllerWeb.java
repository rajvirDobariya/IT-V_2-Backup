...
public class SendOtpControllerWeb {

	Logger logger = LoggerFactory.getLogger(SendOtpControllerWeb.class);
	...
	@RequestMapping(value="/sendOtp/WEB", method = RequestMethod.POST,produces = "application/json")
	...
	@RequestMapping(value="/validateOTP/WEB", method = RequestMethod.POST,produces = "application/json")

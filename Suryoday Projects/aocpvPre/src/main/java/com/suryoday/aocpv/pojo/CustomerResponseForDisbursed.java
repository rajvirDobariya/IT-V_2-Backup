...
public class CustomerResponseForDisbursed {
	...
	public CustomerResponseForDisbursed(long mobilePhone, long customerID, String memberName, String dateOfBirth, String address,
			String state, String postal, String branchId, String amount, String status, String createDate,
			long applicationNo, String updateDate) {
		super();
		this.mobilePhone = mobilePhone;
		this.customerID = customerID;
		this.memberName = memberName;

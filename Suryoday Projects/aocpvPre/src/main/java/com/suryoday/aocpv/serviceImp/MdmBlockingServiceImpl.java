...
public class MdmBlockingServiceImpl implements MdmBlockingService{
    ...
    public JSONObject tab(String bearer, String deviceId) throws IOException {
    	...
    	try {
            ...
            logger.debug("https://eu04.manage.samsungknox.com/emm/oapi/device/selectDeviceInfoByGoogleDeviceId");
    		...
    		httpConn.setRequestProperty("Cookie", "AWSALB=6YVIGrzm11TwUppV8hebBEGI5pw9GX1muDQ6RoM/dohIFl7LNG/lJRZ5zHzMIVV7SwV0ZZw5MegWISXSAOjVgF5OJxOgeZX4YxLS1VXTkdD24ZjezSqLabGbpRoe; AWSALBCORS=6YVIGrzm11TwUppV8hebBEGI5pw9GX1muDQ6RoM/dohIFl7LNG/lJRZ5zHzMIVV7SwV0ZZw5MegWISXSAOjVgF5OJxOgeZX4YxLS1VXTkdD24ZjezSqLabGbpRoe");
	...
	public JSONObject samsungknox() throws IOException {
    	...
    	try {
            ...
            logger.debug("https://eu04.manage.samsungknox.com/emm/oauth/token?grant_type=client_credentials&client_id=Jyotibyod@byod.suryodaybank.com&client_secret=Suryoday@124");
    		HttpURLConnection httpConn = (HttpURLConnection) url.openConnection();

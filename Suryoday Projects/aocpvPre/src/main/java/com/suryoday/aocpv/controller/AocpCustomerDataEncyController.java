	     ...
	     String branchid=jsonObject.getJSONObject("Data").getString("branchid").toString();
	    	     ...
	    	     }if(jsonObject.getJSONObject("Data").has("upiVerify"))
	    	     {
	    		  ...
	    		  aocpCustomer.setBestOfferAmount(fetchByApplicationId.getRequiredAmount());
	     		     ...
	     		     aocpvIncomeDetails.setAadharNoVerify("YES");
		    ...
		    // logger.debug("PD request"+jsonRequest);
		     ...
		     aocpCustomer.setUtilityBill(!utilityBill.equals("")?utilityBill:aocpCustomer.getUtilityBill());
...
//								 }
					...
					String count =aocpvIncomeService.saveAll(aocpvIncomeDetails);
		     ...
		     if(count.equals("two") || aocpCustomer.getGuarantorRemarks()!=null) {
		    	aocpCustomer.setFlowStatus(flowStatus); 
		     }
...
//			 		return new ResponseEntity<Object>(data3, HttpStatus.BAD_REQUEST);
	...
	@RequestMapping(value="/fetchByBranchIdency", method = RequestMethod.POST,produces = "application/json")
...
@RequestMapping(value="/calculateEmiEncy", method = RequestMethod.POST)
public ResponseEntity<Object> calculateEmi(@RequestBody String jsonRequest,
	...
	String decryptContainerString = AppzillonAESUtils.decryptContainerString(encryptString, key);
	 ...
	 String	data = EMICalculator.toString();
		String encryptString2 = AppzillonAESUtils.encryptStringtoContainer(data, key);
		org.json.simple.JSONObject data2 = new org.json.simple.JSONObject();
		data2.put("value", encryptString2);
		org.json.simple.JSONObject data3 = new org.json.simple.JSONObject();

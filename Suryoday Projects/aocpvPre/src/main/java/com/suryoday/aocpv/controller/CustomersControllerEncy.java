...
//				response.put("Data", response5);
			 ...
			 if(getResponse!=null) {
				...
				// JSONObject jsonObject3 = jsonObject2.getJSONObject("Data");
							 ...
							 Data3= Data1.getJSONObject("Data");
							 if(Data3.has("CRMCustDataResponse")) {
								  
								 Data5.put("Data", Data1.getJSONObject("Data"));
								  h= HttpStatus.OK;
							 }
							 else 
							 {
								 Data5.put("Error",  Data1.getJSONObject("Error"));
								
								 h= HttpStatus.BAD_REQUEST; 
							 }
				
				// logger.debug(" final Data"+Data5.toString());
				String data4 = Data5.toString();
				...
				//logger.debug(data8);
				return new ResponseEntity<Object>(data8.toString(), h);

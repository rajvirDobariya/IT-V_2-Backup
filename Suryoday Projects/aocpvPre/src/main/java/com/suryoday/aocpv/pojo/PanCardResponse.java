...
public PanCardResponse(String lastUpdatedDate, String firstName, String nameOnCard, String middlename, String lastName,
		String panTitle, String panID, String pan_Status) {
	super();
	LastUpdatedDate = lastUpdatedDate;
	FirstName = firstName;
	NameOnCard = nameOnCard;

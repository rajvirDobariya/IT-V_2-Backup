...
public interface UserRepository extends JpaRepository<User, String> {
	...
	@Transactional
	@Modifying
	@Query("UPDATE User u SET u.branchId = :branchId ,u.branchName=:branchName WHERE u.id = :id")
	void saveBranch(@Param("id") String id, @Param("branchId") Long branchId,@Param("branchName")String branchName);

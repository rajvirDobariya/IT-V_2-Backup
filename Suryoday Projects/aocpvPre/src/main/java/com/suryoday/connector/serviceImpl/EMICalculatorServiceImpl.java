...
public class EMICalculatorServiceImpl implements EMICalculatorService{
	...
	private static Logger logger = LoggerFactory.getLogger(EMICalculatorServiceImpl.class);
	...
	public JSONObject EMICalculator(JSONObject jSONObject, JSONObject header) {
		...
		try {
			...
			logger.debug(x.BASEURL+"loan/emi/calculator?api_key="+x.api_key);
			 obj =new URL(x.BASEURL+"loan/emi/calculator?api_key="+x.api_key);

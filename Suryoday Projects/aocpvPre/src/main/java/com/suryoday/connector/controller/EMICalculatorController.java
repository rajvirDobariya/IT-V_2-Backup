	...
	public ResponseEntity<Object> sendEmail(@RequestBody String bm,
		...
		JSONObject Header= new JSONObject();
		 ...
		 String LoanOutstanding="0";
			...
			if(X_Request_ID.equals("HOTFOOT"))
			{
				...
				PreApprovedListVikasLoan loanDetails =loanInputService.fetchByCustomerId(customerId);
		...
		JSONObject getloanDetails = getLoanDetailsService.getLoanDetails(accountNo, header);
					...
					JSONObject Data4= new JSONObject(Data3);
					 if(Data4.has("Data")) {
		 LoanOutstanding= Data4.getJSONObject("Data").getJSONObject("AccountDetails").getJSONObject("LoanDtls").getString("LoanOutstanding");

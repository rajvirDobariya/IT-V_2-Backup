...
public class LoanCreationServiceImpl implements LoanCreationService {
	...
	private static Logger logger = LoggerFactory.getLogger(LoanCreationServiceImpl.class);

	public JSONObject loanCreation(JSONObject jSONObject, JSONObject header) {

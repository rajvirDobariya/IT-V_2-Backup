...
public class RegistrationPageController {
	...
	@RequestMapping(value="/registorPage", method = RequestMethod.POST)
	public ResponseEntity<Object> savePersonalDetailsData(@RequestParam("file") MultipartFile files[],@RequestParam("Data") String jsonRequest ,
	    ...
	    //  String pancardResponse = jsonObject.getJSONObject("Data").getString("pancardResponse");
		...
		//	String gstResponse = jsonObject.getJSONObject("Data").getString("gstResponse");
		...
		//	String aadhaarResponse = jsonObject.getJSONObject("Data").getString("aadhaarResponse");
			...
			String addressDetailsFlow = jsonObject.getJSONObject("Data").getJSONObject("addressDetails").getString("flowStatus");
			...
			String othersDetailsFlow = jsonObject.getJSONObject("Data").getJSONObject("othersDetails").getString("flowStatus");
			...
			if(entity.isEmpty() && mobile.isEmpty() && mobileVerify.isEmpty() && companyName.isEmpty() && presentOccupation.isEmpty() 
					&& mobile.isEmpty() && mobileVerify.isEmpty() && mobileNo2.isEmpty() && email.isEmpty() && emailVerify.isEmpty() 
					&& mobilelinkwithaadhar.isEmpty() && dob.isEmpty() && custname.isEmpty()) {			

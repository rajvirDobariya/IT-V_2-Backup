...
public class UserDto {
	...
	public String toString() {
		return "UserDto [userName=" + userName + ", branchId=" + branchId + ", isAdmin=" + isAdmin + ", isActive="
				...
				+ ", updatedBy=" + updatedBy + ", branchIdArray=" + branchIdArray + ", userAccess=" + userAccess
				+ ", department=" + department + ", emailId=" + emailId + ", otherRole=" + otherRole
				+ ", allowCreditAccess=" + allowCreditAccess + "]";
	}

				...
				if (Data1.has("status-code"))
					if (Data1.getString("status-code").equals("103")) {
						h = HttpStatus.BAD_REQUEST;
						 ...
						 if(Data1.has("result"))
						 {
							 Data1.getJSONObject("result").getString("ac_name");
							 Data1.getJSONObject("result").remove("ac_name");
							 Data1.getJSONObject("result").put("ac_name",Data1.getJSONObject("result").getString("name"));

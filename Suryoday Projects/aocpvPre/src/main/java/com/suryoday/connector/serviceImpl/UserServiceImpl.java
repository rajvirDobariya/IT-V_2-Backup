...
public class UserServiceImpl implements UserService {
	...
	public User updateUser(String id, String jsonRequest) throws JsonParseException, JsonMappingException, IOException {
		...
		if (findById.isPresent()) {
			 ...
			 * user.setAllowCreditAccess(userDto.getAllowCreditAccess()); } else {
...
//		userRole.setId(id);
	...
	public String getSessionId(String id, HttpServletRequest request) {
		...
		try
		{
			 ...
			 attribute = request.getSession().getAttribute(id);
	    	logger.debug("sessionattribute"+attribute);
...
@Override
	...
	public HRUsersData fetchUserFromHr(String userId) {
		...
		throw new NoSuchElementException("You are not Authorize to view");
	}

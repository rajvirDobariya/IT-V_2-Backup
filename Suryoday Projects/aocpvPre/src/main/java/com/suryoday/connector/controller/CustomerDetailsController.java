...
public class CustomerDetailsController {
	...
	@RequestMapping(value="/fetchByCustomerId", method = RequestMethod.POST,produces = "application/json")
	...
	@RequestMapping(value="/download/customers.xlsx", method = RequestMethod.POST,produces = "application/json")
    public void downloadCsv(@RequestBody String bm,
			 ...
			 @RequestHeader(name = "X-Transaction-ID", required = true) String X_Transaction_ID,
			 @RequestHeader(name = "X-User-ID", required = true) String X_User_ID,
			 @RequestHeader(name = "X-Request-ID", required = true) String X_Request_ID,HttpServletRequest req, HttpServletResponse response) throws Exception {
...
//        String string = body.toString();
         ...
         //JSONObject jsonObject = new JSONObject(string);
          // customerId = jsonObject.getJSONObject("CustomerDetails").getLong("customerId");

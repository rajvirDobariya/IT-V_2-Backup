...
//						linkMobileToMultipleCIF(hastReqStatus.getMobileNo(), hastReqStatus.getCIF(),
//								hastReqStatus.getLinkToCIF());
	...
	public JSONObject linkMobileToMultipleCIF(String moblieNo, String existingCIF, String linkToCIF) {
		System.out.println("linkMobileToMultipleCIF :: moblieNo :: " + moblieNo + " :: existingCIF :: " + existingCIF
				+ " :: linkToCIF :: " + linkToCIF);
		...
		try {
			...
			throw new RuntimeException("Error occurred while creating case: " + e.getMessage());
		}
		logger.debug("Link mobile to multiple CIF Response ::" + jsonResponse);
		return jsonResponse;
	}

...
//			userlog.setEndDate(now);
		...
		else if(currenStage.equalsIgnoreCase("RO")|| currenStage.equalsIgnoreCase("SALES_DISCREPANCY") || currenStage.equalsIgnoreCase("ADMIN")) {
		...
		else if(X_Request_Flag.equalsIgnoreCase("Edit"))
		{
			...
			disbursement.setEndDate(now);
			if(currenStage.equalsIgnoreCase("RO")|| currenStage.equalsIgnoreCase("SALES_DISCREPANCY")|| currenStage.equalsIgnoreCase("CREDIT_ADMIN")|| currenStage.equalsIgnoreCase("Reject")) {
				disbursement.setCurrentStage("CREDIT");
			}
			...
			else if(currenStage.equalsIgnoreCase("CREDIT_OPS") && assignRole.equalsIgnoreCase("SALESANDCREDIT_DISCREPANCY"))
			{
			...
			else if(currenStage.equalsIgnoreCase("CREDIT")||currenStage.equalsIgnoreCase("CREDIT_DISCREPANCY")|| currenStage.equalsIgnoreCase("CREDITOPS_ADMIN"))
			{
				disbursement.setCurrentStage("CREDIT_OPS");
			}
			else if(currenStage.equalsIgnoreCase("CREDIT_OPS")||currenStage.equalsIgnoreCase("CREDITOPS_DISCREPANCY")|| currenStage.equalsIgnoreCase("OPS_ADMIN"))
			{
			...
			disbursementservice.save(disbursement);
			if(assignRole.equalsIgnoreCase("SALESANDCREDIT_DISCREPANCY")&&currenStage.equalsIgnoreCase("CREDIT_OPS"))
			{
				String role1="CREDIT";
				...
				if(save.equalsIgnoreCase("Success"))
				{
					String role3="RO";
					String role4="CREDIT";
					List<LoanTrackingUserLog> list2=userlogservice.fetchByDiscrepancy(Long.parseLong(applicationNo),role3,role4);
	...
	public ResponseEntity<Object> fetchByDateEncy(@RequestBody String jsonRequest,
		...
		String createdBy = jsonObject.getJSONObject("Data").getString("CreatedBy");
		 ...
		 {
			 List<LoanTrackingDisbursement> list=disbursementservice.fetchByDateAndUserRole(startdate,enddate,userRole);
			 logger.debug("List"+list);
				logger.debug("db Call end" + list);
				 JSONArray j= new JSONArray(list);
				org.json.simple.JSONObject response = new org.json.simple.JSONObject();
	...
	public ResponseEntity<Object> fetchByUserRoleEncy(@RequestBody String jsonRequest,
		...
		List<LoanTrackingDisbursement> list=disbursementservice.fetchByUserRoleAndUserId(userRole,userId,startdate,enddate);
		logger.debug("List"+list);
		JSONArray j=new JSONArray(list);
		logger.debug("List"+list);
		logger.debug("db Call end" + list);
	...
	public ResponseEntity<Object> myTasksEncy(@RequestBody String jsonRequest,
		...
		String userRole = jsonObject.getJSONObject("Data").getString("UserRole");
		String userId = jsonObject.getJSONObject("Data").getString("UserId");
		if(userRole.equalsIgnoreCase("CREDIT_ADMIN") || userRole.equalsIgnoreCase("CREDITOPS_ADMIN") || userRole.equalsIgnoreCase("OPS_ADMIN"))
		{
			userId="ALL";
			List<LoanTrackingDisbursement> list=disbursementservice.fetchMyTasks(userRole,userId,startdate,enddate);
			logger.debug("List"+list);
			JSONArray j=new JSONArray(list);
			logger.debug("List"+list);
			logger.debug("db Call end" + list);
	...
	public ResponseEntity<Object> searchByNameOrApplication(@RequestBody String jsonRequest,
		...
		List<LoanTrackingDisbursement> list=disbursementservice.searchByNameOrApplication(name,Long.parseLong(applicationId));
		JSONArray array=new JSONArray(list);
		logger.debug("List"+list);
		logger.debug("db Call end" + list);
		org.json.simple.JSONObject response = new org.json.simple.JSONObject();

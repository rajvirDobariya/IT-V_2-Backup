...
public class LucController {
	...
	public ResponseEntity<Object> addLuc(@RequestParam(name = "Data") String request,
		...
		LOG.debug(
				"LucController :: addLuc :: requestString : {} : X_User_ID : {} : X_Session_ID : {} : channel : {}",
				null, X_User_ID, X_Session_ID, channel);
		// 1
		JSONObject responseJson = lucService.addLuc(request, channel, X_Session_ID, X_User_ID, false, image);
	...
	public ResponseEntity<Object> getLucs(@RequestBody String request,
		...
		LOG.debug(
				"LucController :: getLucs :: requestString : {} : X_User_ID : {} : X_Session_ID : {} : channel : {}",
				null, X_User_ID, X_Session_ID, channel);
		// 1
		JSONObject responseJson = lucService.getLucs(request, channel, X_Session_ID, X_User_ID, false);
		return new ResponseEntity<Object>(responseJson.toString(), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getLucExcel(@RequestBody String request,
		...
		LOG.debug(
				...
				null, X_User_ID, X_Session_ID, channel);
		// 1
		JSONObject responseJson = lucService.getExcelLuc(request, channel, X_Session_ID, X_User_ID, false);
		return new ResponseEntity<Object>(responseJson.toString(), HttpStatus.OK);
	}

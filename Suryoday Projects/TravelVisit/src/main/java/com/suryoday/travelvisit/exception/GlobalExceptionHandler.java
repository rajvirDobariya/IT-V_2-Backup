package com.suryoday.travelvisit.exception;
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(TravelVisitException.class)
	public ResponseEntity<String> handleTravelVisitException(TravelVisitException ex) {

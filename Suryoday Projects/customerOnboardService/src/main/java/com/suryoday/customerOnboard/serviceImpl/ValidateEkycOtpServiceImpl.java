...
import com.suryoday.customerOnboard.controller.AuthController;
import com.suryoday.customerOnboard.others.CustomProperties;
import com.suryoday.customerOnboard.others.EncryptDecryptHelper;
import com.suryoday.customerOnboard.others.Encrypter;
...
@Service
public class ValidateEkycOtpServiceImpl implements ValidateEkycOtpService{
...
//		String stan="889955";
		...
		String ci="20250929";
		Encrypter e1= new Encrypter(prop.getAuthPreProdCert()+"uidai_auth_preprod.cer");

...
@Service
public class ErrorResponseImpl implements ErrorResponseService{
	private static Logger logger = LoggerFactory.getLogger(ErrorResponseImpl.class);
	
	@Override
	public String getError(String kycRes, long applicationno) {
		int errorcode = Integer.parseInt(ErrorResponseImpl.KycRespCall(kycRes,applicationno));
		String jsonresponse = "";
		switch (errorcode) {

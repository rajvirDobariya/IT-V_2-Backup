...
import com.suryoday.customerOnboard.others.GenerateProperty;
...
@Service
public class AadharReferenceServiceImpl implements AadharReferenceService{
	
private static Logger logger = LoggerFactory.getLogger(AadharReferenceServiceImpl.class);

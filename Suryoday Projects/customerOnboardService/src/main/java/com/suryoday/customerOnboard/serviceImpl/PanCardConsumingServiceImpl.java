...
@Service
public class PanCardConsumingServiceImpl implements PanValidationService{

	private static Logger logger = LoggerFactory.getLogger(PanCardConsumingServiceImpl.class);

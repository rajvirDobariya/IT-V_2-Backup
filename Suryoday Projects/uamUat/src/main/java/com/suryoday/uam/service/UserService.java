...
public interface UserService {
	...
	public String getSessionIdForWeb(String userId, HttpServletRequest request, String string);

	public String validateSessionIdWeb(String x_Session_ID, HttpServletRequest request);

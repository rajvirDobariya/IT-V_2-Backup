...
public class SendOtpEncyControllerWeb {
	...
	public ResponseEntity<Object> sendOtpAndEmail(@RequestBody String bm,
		...
		if(fetchById.getSendSmscallId() != null && fetchById.getSendSmscallId()>=3 || fetchById.getSmscallId() != null && fetchById.getSmscallId()>=3) {
		...
		else if(fetchById.getLockingEndTimeSendSms()!=null && fetchById.getLockingEndTimeSendSms().isAfter(LocalDateTime.now())) {
...
//				String encodedId=userService.validateUser(X_User_ID);
		    if (sessionId ) {
					...
					String mob = jsonObject.getJSONObject("Data").getString("MobileNumber");
//					JSONObject sendOtp = otpService.sendOtp(jsonObject, Header);
					...
					if (sendOtp != null) {
						...
						if (Data1.has("Data")) {
							...
							Data1.getJSONObject("Data").put("mobile", mob.replaceAll("\\w(?=\\w{4})", "X"));
...
//				if(X_User_ID.equals("92485") || X_User_ID.equals("92271") || X_User_ID.equals("92331") || X_User_ID.equals("38339")) {
					String validate="{\r\n"

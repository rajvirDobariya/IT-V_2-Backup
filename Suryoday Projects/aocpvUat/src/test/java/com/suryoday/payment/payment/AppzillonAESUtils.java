...
public class AppzillonAESUtils {
	...
	public static String decryptString(String cypher, String key, String textToDecrypt, String salt, byte[] iv) {
		LOG.debug("Cipher -:" + cypher + ", key:" + key + ", texToDecrypt :" + textToDecrypt + ", salt :" + salt
				+ ", iv:" + iv + ", OS -:");
		SecretKeySpec skeySpec = null;
	...
	public static String decryptContainerString(String pCipherString, String pKey) {
		...
		LOG.debug(" decryptContainerString key for encryption after checking the length -:" + lKey);
...
//				+ " decryptContainerString Decrypted AppzillonBody -:"+ decryptedString);
	...
	public static String encryptStringtoContainer(String pPlainText, String pKey) {
		...
		String lKey = getPaddedKey(pKey);
		LOG.debug(" encryptStringtoContainer key for decryption after checking the length -:" + lKey);
	...
	public static void main(String args[]) {
		...
		String key = "f419f390-19b6-47d2-a428-5cdf77d5f258";
		...
		String encryptedText = "uabb6nRG/uHhz6wZI6dxH1vXnYbVj/44X00w1iH0owDq+qiu6BhF9mtBW3GYUM2gzCVM5VA8lJ40c+ay2kKclbiX1B6GUz6jjqJyVxSumZxRE+ki7G4v9PRI0MOQOE50IApKg2R92JTy0P/TZOF8mg3A0lmaPk7tmQiRK4banhdSraWw6GcbJQbb/uovwUkwu9As2Zx3qjaR1SWnr5sF2Q==";
		// key = "12345com.iexceed.qateam" ;
		String paddingMask = "$$$$$$$$$$$$$$$$";

		String a = "{\r\n" + "    \"Data\": {\r\n" + "        \"UserID\": \"90796\",\r\n"
				+ "        \"Password\": \"Aocpv@123\"\r\n" + "    }\r\n" + "}";
		String planReq = a.toString();
		System.out.println(planReq);

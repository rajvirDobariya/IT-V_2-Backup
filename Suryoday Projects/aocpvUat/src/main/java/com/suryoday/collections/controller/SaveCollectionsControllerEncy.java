...
public class SaveCollectionsControllerEncy {
	...
	Logger logger = LoggerFactory.getLogger(SaveCollectionsControllerEncy.class);

	@RequestMapping(value = "/saveReceiptEncy", method = RequestMethod.POST)
	public ResponseEntity<Object> saveReceiptData(@RequestParam("file") MultipartFile files,
	...
	@RequestMapping(value = "/saveUpdateTrailEncy", method = RequestMethod.POST)

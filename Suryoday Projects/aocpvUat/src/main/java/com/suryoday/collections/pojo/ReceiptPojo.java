...
public class ReceiptPojo {
	...
	public String toString() {
		return "ReceiptPojo [id=" + id + ",customerID=" + customerID + ", accountNo=" + accountNo + ", custName="
				+ custName + ", ptpAmount=" + ptpAmount + ", emiAmount=" + emiAmount + ", emiOverdue=" + emiOverdue
				+ ", charges=" + charges + ", totalAmount=" + totalAmount + ", modeOfPayment=" + modeOfPayment
				+ ", receiptNo=" + receiptNo + ", totalCount=" + totalCount + ", panNO=" + panNO + ", mobileNo="
				+ mobileNo + ", remarks=" + remarks + ", upiID=" + upiID + ", currentDate=" + currentDate
				+ ", branchId=" + branchId + ", paymanetStatus=" + paymanetStatus + "]";
	}
}

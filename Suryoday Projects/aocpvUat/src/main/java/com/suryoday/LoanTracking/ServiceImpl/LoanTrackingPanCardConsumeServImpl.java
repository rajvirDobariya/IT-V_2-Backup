...
@Component
public class LoanTrackingPanCardConsumeServImpl implements LoanTrackingPanCardConsumeService {
	private static Logger logger = LoggerFactory.getLogger(LoanTrackingPanCardConsumeServImpl.class);

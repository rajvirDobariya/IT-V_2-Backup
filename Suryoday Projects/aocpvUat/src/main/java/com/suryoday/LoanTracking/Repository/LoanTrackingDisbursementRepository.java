...
public interface LoanTrackingDisbursementRepository extends JpaRepository<LoanTrackingDisbursement, Long> {
	...
	List<LoanTrackingDisbursement> fetchByDate(@Param("s") LocalDateTime startdate, @Param("e") LocalDateTime enddate,
			String createdBy);
	...
	List<LoanTrackingDisbursement> fetchByUserRoleAndUserId(String userRole, String userRole1, String userId,
	...
	List<LoanTrackingDisbursement> fetchByDateAll(@Param("s") LocalDateTime startdate,
	...
	List<LoanTrackingDisbursement> fetchMyTasks(String userRole, String userRole1, String userRole2, String userId,
			@Param("s") LocalDateTime startdate, @Param("e") LocalDateTime enddate);
	...
	int countPendingRecordsByProduct(String currentStage, String currentStage2, String currentStage3,
			String productType);
	...
	List<LoanTrackingDisbursement> fetchByDateAndUserRole(@Param("s") LocalDateTime startdate,
			@Param("e") LocalDateTime enddate, String userRole, String userRole2, String userRole3);
	...
	List<LoanTrackingDisbursement> findTopTenByDate(@Param("s") LocalDateTime startdate,
			@Param("e") LocalDateTime enddate);

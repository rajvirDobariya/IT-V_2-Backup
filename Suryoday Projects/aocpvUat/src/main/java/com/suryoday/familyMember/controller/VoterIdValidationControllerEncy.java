...
public class VoterIdValidationControllerEncy {
	...
	private static Logger logger = LoggerFactory.getLogger(VoterIdValidationControllerEncy.class);
	...
	public ResponseEntity<Object> voterId(@RequestBody String bm,
		...
		if (sessionId == true) {
			...
			// {"Data":{"epic_no":"SHA472208388898","consent":"Y"}}
			...
			if (voterID != null) {
				...
				String encryptString2 = AppzillonAESUtils.encryptStringtoContainer(Data1.toString(), key);

...
@Service
public class AadharValidationServiceImpl implements AadharValidationService {

	private static Logger logger = LoggerFactory.getLogger(AadharValidationServiceImpl.class);

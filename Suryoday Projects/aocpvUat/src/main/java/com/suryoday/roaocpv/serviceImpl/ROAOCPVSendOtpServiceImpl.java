...
import com.suryoday.roaocpv.service.ROAOCPVSendOtpService;

@Service
public class ROAOCPVSendOtpServiceImpl implements ROAOCPVSendOtpService {

	private static Logger logger = LoggerFactory.getLogger(ROAOCPVSendOtpServiceImpl.class);

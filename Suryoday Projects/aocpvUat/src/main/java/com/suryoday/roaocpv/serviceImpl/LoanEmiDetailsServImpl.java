...
@Component
public class LoanEmiDetailsServImpl implements LoanEmiDetailsService {
	private static Logger logger = LoggerFactory.getLogger(LoanEmiDetailsServImpl.class);

	@Override
	public JSONObject loanEmiDetails(String applicationNo, JSONObject header) {
	...
	private JSONObject getRequest(String applicationNo) {
		...
		data.put("Method", "LOANDETAILS");
		data.put("OurBranchID", "1102");
		data.put("AccountId", "11027030000107");
		data.put("LoanSeries", "");
		return data;

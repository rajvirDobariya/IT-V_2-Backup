...
public class CRMServiceImpl implements CRMService {
	...
	public JSONObject getRepayment() {
		...
		try {
			...
			URL url = new URL(
					"https://intramashery.suryodaybank.com/ssfb/repayment/schedule/generation?api_key=sbx8chmdwa9f82du6snc3624");
	...
	private static JSONObject getResponse1(String parent, JSONObject sendAuthenticateResponse, HttpURLConnection con,

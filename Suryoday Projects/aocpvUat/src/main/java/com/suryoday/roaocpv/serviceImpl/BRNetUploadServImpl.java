...
@Component
public class BRNetUploadServImpl implements BRNetUploadService {
	private static Logger logger = LoggerFactory.getLogger(BRNetUploadServImpl.class);
...
//				getHeadersRequestInfo(con);
	...
	private JSONObject getRequest(String applicationNo) {
		...
		parent.put("Method", "POSTCLIENTIMAGE");
		parent.put("BranchID", "1049");
		parent.put("ClientID", "10490001684");
		parent.put("ImageUploadTypeID", "C");
		parent.put("AccountID", "10490TM0000004");
		parent.put("ImageTypeID", "P");
		parent.put("Image", "");
		return parent;
	}
	...
	@Override
	public JSONObject uploadImage(String branchId, String clientId, JSONObject header) {
		JSONObject sendResponse = new JSONObject();
		JSONObject request2 = getRequest2(branchId, clientId);
		URL obj = null;
		try {
			...
			sendResponse = getResponse(request2, sendResponse, con, "POST");
//				
//				getHeadersRequestInfo(con);
	...
	private JSONObject getRequest2(String branchId, String clientId) {
		JSONObject parent = new JSONObject();
		parent.put("Method", "POSTCLIENTIMAGE");
		parent.put("BranchID", branchId);
		parent.put("ClientID", clientId);
		parent.put("ImageUploadTypeID", "C");
		parent.put("AccountID", "10490TM0000004");
		parent.put("ImageTypeID", "P");
		parent.put("Image", "");

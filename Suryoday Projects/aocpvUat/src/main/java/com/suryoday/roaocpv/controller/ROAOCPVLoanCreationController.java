...
public class ROAOCPVLoanCreationController {

	@Autowired
	ROAOCPVLoanCreationService loancreationservice;

	private static Logger logger = LoggerFactory.getLogger(ROAOCPVLoanCreationController.class);
	...
	@RequestMapping(value = "/checkLoanStatus", method = RequestMethod.POST, produces = "application/json")

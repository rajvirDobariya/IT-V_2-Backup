...
public class LoanAgreementServiceImpl implements LoanAgreementService {
	...
	public String reportPdf(StringBuilder htmlString, long applicationNoInLong) {
		...
		htmlString.append(new String("<!DOCTYPE html>\r\n" + "<html>\r\n" + "    <head>\r\n" + "        <style>\r\n"
				...
				+ "        <br>\r\n" + "        <br>\r\n" + "            <p style=\"font-size: 10px;\"> I, ___"
				+ aocpvLoanCreation.getCustomerName()
				+ "____, W/o/D/o of____________________________, resident of _____________________________________________ , do hereby confirm </p>\r\n"
				...
				+ "        <p style=\"font-size: 10px;\"> Small Finance Bank Ltd to disburse the loan amount into my bank account no. __"
				+ aocpvLoanCreation.getLoanAccoutNumber()
				+ "___ opened with _Suryoday Small Finance Bank Ltd_Bank</p>                 \r\n" + "        <br>\r\n"
				+ "        <br>\r\n" + "        <br>\r\n"

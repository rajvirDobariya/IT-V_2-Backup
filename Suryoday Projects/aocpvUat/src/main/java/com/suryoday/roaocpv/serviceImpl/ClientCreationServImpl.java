...
//				getHeadersRequestInfo(con);
	...
	private JSONObject getRequest(String applicationNo) {
		...
		// BRNetMasters
		// brNetMasters=brmastersservice.fetchBrNetMasters(categotyType,pincodeP);
		JSONObject Data = new JSONObject();
		Data.put("Method", "POSTINDIVIDUALCLIENTCREATION");
//		Data.put("BranchId",branchid);
		Data.put("BranchId", "057");
		Data.put("ClientID", Long.toString(aocpCustomer.getCustomerId()));
		Data.put("ClientTypeID", "I");
		Data.put("PersonalDetails", "<dt_PersonalDetails><OurBranchID>057</OurBranchID><ClientID>"
				+ aocpCustomer.getCustomerId() + "</ClientID><ClientTypeID>I</ClientTypeID><Name>"
				+ aocpCustomer.getName() + "</Name><TitleID>" + aocpvIncomeDetails.getTitle() + "</TitleID><FirstName>"
				+ aocpvIncomeDetails.getFirstName() + "</FirstName><MiddleName>" + middleName
				+ "</MiddleName><LastName>" + aocpvIncomeDetails.getLastName() + "</LastName><GenderID>"
				+ aocpvIncomeDetails.getGender()
				+ "</GenderID><IsDOBGiven>0</IsDOBGiven><DateOfBirth></DateOfBirth><Age>" + aocpvIncomeDetails.getAge()
				+ "</Age><AgeAsOn>01/01/2020</AgeAsOn><NationalityID>I</NationalityID><ResidentID>R</ResidentID><PassportNo></PassportNo><PassportIssuedCityID></PassportIssuedCityID><PassportExpiryDate>03/31/2024</PassportExpiryDate><LiteracyLevelID>PG</LiteracyLevelID><MaritalStatusID>"
				+ aocpvIncomeDetails.getMarried()
				+ "</MaritalStatusID><NumberOfHouseMembers>5</NumberOfHouseMembers><NumberOfChildren>1</NumberOfChildren><NumberOfDependents>1</NumberOfDependents><BloodGroupID>B+</BloodGroupID><CanDonateBlood></CanDonateBlood><OpenedBy></OpenedBy><OpenedDate>01/31/2022</OpenedDate><ID1CaptionID>06</ID1CaptionID><ID1>"
				+ aocpvIncomeDetails.getAadharCard() + "</ID1><ID2CaptionID>02</ID2CaptionID><ID2>"
				+ aocpvIncomeDetails.getPanCard() + "</ID2><ID3CaptionID>11</ID3CaptionID><ID3>"
				+ aocpvIncomeDetails.getMobile()

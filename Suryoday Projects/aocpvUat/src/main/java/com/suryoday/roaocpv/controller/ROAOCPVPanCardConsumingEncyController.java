...
public class ROAOCPVPanCardConsumingEncyController {

	@Autowired
	ROAOCPVPanCardConsumingService panCardConsumingService;
	...
	private static Logger logger = LoggerFactory.getLogger(ROAOCPVPanCardConsumingEncyController.class);

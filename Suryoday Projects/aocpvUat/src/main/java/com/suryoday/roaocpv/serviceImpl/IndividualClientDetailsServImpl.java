...
@Component
public class IndividualClientDetailsServImpl implements IndividualClientDetailsService {
	private static Logger logger = LoggerFactory.getLogger(IndividualClientDetailsServImpl.class);

	@Override
	public JSONObject indivialClientDetails(String branchId, String clientId, JSONObject header) {
		JSONObject sendResponse = new JSONObject();
		JSONObject request = getRequest(branchId, clientId);
		URL obj = null;
		try {
	...
	private JSONObject getRequest(String branchId, String clientId) {
		JSONObject data = new JSONObject();
		data.put("Method", "INDIVIDUALCLIENTDETAILS");
		data.put("OurBranchId", branchId);

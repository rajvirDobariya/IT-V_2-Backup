...
@Component
public class LoanAccountDetailsServImpl implements LoanAccountDetailsService {
	private static Logger logger = LoggerFactory.getLogger(LoanAccountDetailsServImpl.class);

	@Override
	public JSONObject getLoanAccDetails(String accountId, JSONObject header) {
		JSONObject sendResponse = new JSONObject();
		JSONObject request = getRequest(accountId);
		URL obj = null;
		try {
	...
	private JSONObject getRequest(String accountId) {
		JSONObject data = new JSONObject();
		data.put("Method", "GetLoanAccountDetails");

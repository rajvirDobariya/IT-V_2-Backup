...
import com.suryoday.mhl.service.MHLVoterIDService;

@RestController
@RequestMapping("/mhl")
public class MHLVoterIDEncyController {

	@Autowired
	MHLVoterIDService mHLVoterIDService;

	@Autowired
	UserService userService;

	private static Logger logger = LoggerFactory.getLogger(MHLVoterIDEncyController.class);
	...
	public ResponseEntity<Object> voterId(@RequestBody String bm,
		...
		if (sessionId) {
			...
			JSONObject voterID = this.mHLVoterIDService.voterID(jsonObject, Header);

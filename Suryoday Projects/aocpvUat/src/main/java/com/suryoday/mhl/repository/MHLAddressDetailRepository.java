...
public interface MHLAddressDetailRepository extends JpaRepository<AddressDetails, Integer> {
	...
	Optional<AddressDetails> getByApplicationNo(@Param("applicationNo") String applicationNo,
			@Param("applicationRole") String applicationRole, @Param("addressType") String addressType);

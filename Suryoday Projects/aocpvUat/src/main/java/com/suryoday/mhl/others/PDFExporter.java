...
public class PDFExporter {
	...
	public void export(HttpServletResponse response) throws Exception {
		...
		table3.addCell(new Phrase(
				"Life Insurance Rs. 11428.3 for a tenure of 84 Months and Property Insurance Rs. 3140  for a tenure of 84 Months.",
				font));
		table3.addCell(new Phrase(titles.get(19), font));
		table3.addCell(new Phrase(
				"PROPERTY NO. UNIQUE NO.150800101800120203,IRASAVADI VILLAGE & GRAMAPANCHAYATH, CHMARAJANAGAR TALUK & DISTRICT - 571117.",
				font));
		table3.addCell(new Phrase(titles.get(20), font));
		table3.addCell(new Phrase(
				"From the Date of Disbursement, you will be required to pay PEMI interest on 10th of the succeeding month through Cheque, &  84 Equated monthly installments thereafter as mentioned above through NACH. ",
				font));
		...
		table3.addCell(new Phrase(
				"Administrative charges of Rs.5,000 including GST needs to be paid post sanction and Processing Fee of Rs. 10000  including GST , which is non-refundable will be deducted from the loan amount",
				font));
		...
		table3.addCell(new Phrase("1) POSITIVE RCU REPORT\r\n" + "2) POSITIVE LEGAL  AND TECHNICAL REPORT\r\n"
				+ "3) HOUSE CONSTRUCTION BELOW 6 MONTHS LETTER REQUIRED FROM PANCHAYTH SIDE BEFORE DISBURSEMENT",
				font));
		document.add(table3);

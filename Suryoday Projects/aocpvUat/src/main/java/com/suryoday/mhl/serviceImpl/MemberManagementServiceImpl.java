...
public class MemberManagementServiceImpl implements MemberManagementService {
	...
	public String savePersonalData(MemberManagement memberManagement) {
		...
		Optional<MemberManagement> optional = memberManagementRepository
				.getByApplicationNoandRole(memberManagement.getApplicationNo(), memberManagement.getApplicationRole());
	...
	public String deleteByAppNoAndMember(String applicationNo, String member) {
		Optional<MemberManagement> optional = memberManagementRepository.getByApplicationNoandRole(applicationNo,
				member);
		if (optional.isPresent()) {
	...
	public MemberManagement fetchByApplicationAndMemId(String applicationNo, long memberIdInLong) {
		Optional<MemberManagement> optional = memberManagementRepository.fetchByApplicationAndMemId(applicationNo,
				memberIdInLong);
		if (optional.isPresent()) {
			return optional.get();
		}

...
public class PDFAffidivat {
	...
	public void export(HttpServletResponse response) throws Exception {
		...
		table.addCell(new Phrase(
				"PROPERTY PID NO-22-1-5-39, ASSESSMENT NO-1006/970, BR HILLS DOUBLE ROAD C-5, BRAMARAMBA BADAVANE NEAR BRANARAMBA THEATER, CHAMARAJANAGARA 571313",
				font));
		table.addCell(new Phrase(titles.get(22), font));
		table.addCell(new Phrase(
				"BASAVARAJU  K  MANIYAMMA ERASAVADI IRASAVADI CHAMARAJANAGAR CHAMARAJANAGAR KARNATAKA 571441 ", font));

...
public class MHLCibilReportServiceImpl implements MHLCibilReportService {
	...
	public String getJsonRequest(String jsonString) {
		...
		// long customerId =
		// jsonObject.getJSONObject("RequestHeader").getLong("CustomerId");
		// String userId =
		// jsonObject.getJSONObject("RequestHeader").getString("UserId");
		// String password =
		// jsonObject.getJSONObject("RequestHeader").getString("Password");
		// String memberNumber =
		// jsonObject.getJSONObject("RequestHeader").getString("MemberNumber");
		// String securityCode =
		// jsonObject.getJSONObject("RequestHeader").getString("SecurityCode");
		// long productionVersion =
		// jsonObject.getJSONObject("RequestHeader").getLong("ProductVersion");
		// String reportFormat =
		// jsonObject.getJSONObject("RequestHeader").getString("ReportFormat");
		// String productCode =
		// jsonObject.getJSONObject("RequestHeader").getString("ProductCode");
		// String custRefField =
		// jsonObject.getJSONObject("RequestHeader").getString("CustRefField");
		// long kendraIDMFI =
		// jsonObject.getJSONObject("RequestAccountDetails").getLong("KendraIDMFI");
		// long branchIDMFI =
		// jsonObject.getJSONObject("RequestAccountDetails").getLong("BranchIDMFI");
...
//				.getString("InquiryAccount");
	...
	public String getPersonalDetails(MemberManagement member) {
		...
		Optional<AddressDetails> optional = addressDetailRepository.getByApplicationNo(applicationNo, applicationRole,
				addressType);
	...
	public CibilEqifaxDetails saveCibilReportData(CibilEqifaxDetails cibilEqifaxDetails) {
		Optional<CibilEqifaxDetails> fetchByApplicationNoAndMemberId = cibilEqifaxDetailsRepository
				.fetchByApplicationNoAndMemberId(cibilEqifaxDetails.getApplicationNo(),
						cibilEqifaxDetails.getMemberId());
	...
	public CibilEqifaxDetails fetchByapplicationNoAndMemberId(String applicationNo, long memberId) {
		...
		Optional<CibilEqifaxDetails> optional = cibilEqifaxDetailsRepository
				.fetchByApplicationNoAndMemberId(applicationNo, memberID);

...
public class DsaOnBoardEkycController {

	private static Logger logger = LoggerFactory.getLogger(DsaOnBoardEkycController.class);
			...
			if (!hsmData.equals("")) {
				...
				if (!jsonResponse.equals(null)) {
					...
					if (jsonResponse.has("KycRes")) {
						...
						dsaOnboardMemberService.saveResponse("ekyc", "FINGERPRINT", applicationNo,
			...
			if (!hsmData.equals("")) {
				...
				if (!jsonResponse.equals(null)) {
					...
					if (jsonResponse.has("KycRes")) {
						...
						dsaOnboardMemberService.saveResponse("ekyc", "fACEEKYC", applicationNo, DBResponse.toString(),
								member);
			...
			if (!HsmData.equals("")) {
				...
				if (!jsonResponse.equals(null)) {
					...
					if (jsonResponse.has("KycRes")) {
						...
						dsaOnboardMemberService.saveResponse("ekyc", "OTP", applicationNo, DBResponse.toString(),
								member);
						h = HttpStatus.OK;

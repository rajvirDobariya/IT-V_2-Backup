...
public class DsaOnBoardEkycControllerEncy {

	private static Logger logger = LoggerFactory.getLogger(DsaOnBoardEkycControllerEncy.class);
...
//							Long applicationNo1 = Long.parseLong(applicationNo);
							...
							dsaOnboardMemberService.saveResponse("ekyc", "fACEEKYC", applicationNo,
									DBResponse.toString(), member);

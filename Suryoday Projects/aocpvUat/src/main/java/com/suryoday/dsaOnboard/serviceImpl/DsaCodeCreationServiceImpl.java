...
public class DsaCodeCreationServiceImpl implements DsaCodeCreationService {
	...
	private JSONObject getResponse(JSONObject parent, JSONObject sendAuthenticateResponse, HttpURLConnection con,
...
//			 }
		...
		DsaOnboardMember dsaOnboardMember = dsaOnboardMemberService
				.findByApplicationNoAndIsPrimary(dsaOnboardDetails.getApplicationNo(), "YES");
		logger.debug("dsaOnboardMember: " + dsaOnboardMember);
		JSONObject data = new JSONObject();
		data.put("AgencyId", code);// dsa ID
		data.put("AgencyType",
				dsaOnboardDetails.getTypeOfRelationship() != null ? dsaOnboardDetails.getTypeOfRelationship() : "");// DSA/Connector
		...
		data.put("AccountHolderName",
				dsaOnboardDetails.getAccountholderName() != null ? dsaOnboardDetails.getAccountholderName() : "");// SURY0BK0000
		data.put("BankAccountNo",
				dsaOnboardDetails.getBankAccountNo() != null ? dsaOnboardDetails.getBankAccountNo() : "");
		...
		data.put("age_of_proprietor",
				dsaOnboardDetails.getAgeOfProprietor() != null ? dsaOnboardDetails.getAgeOfProprietor() : "");
		data.put("LeadId", "");
		data.put("ConstitutionType",
				dsaOnboardDetails.getConstitutionType() != null ? dsaOnboardDetails.getConstitutionType() : "");
		data.put("LeadName", "");
		JSONArray j = new JSONArray(
				dsaOnboardDetails.getProductType() != null ? dsaOnboardDetails.getProductType() : "");
		...
		if (dsaOnboardMember.getAddress() != null) {
			...
			for (int i = 0; i < addressInJson.length(); i++) {
				...
				String addres = addressLine1 + " " + addressLine2 + " " + addressLine3 + " " + city + " " + " "
						+ district + " " + pincode;
		...
		data.put("AgreementValidityTill",
				dsaOnboardDetails.getLeegalityDate() != null ? dsaOnboardDetails.getLeegalityDate().plusYears(3) : "");
		data.put("NameAsPerBank",
				dsaOnboardDetails.getAccountholderName() != null ? dsaOnboardDetails.getAccountholderName() : "");
		data.put("NameAsPerPan",
		...
		data.put("RmId", "");
		data.put("AadharPanLinked",
				dsaOnboardMember.getAadharPanLinkStatus() != null ? dsaOnboardMember.getAadharPanLinkStatus() : "");

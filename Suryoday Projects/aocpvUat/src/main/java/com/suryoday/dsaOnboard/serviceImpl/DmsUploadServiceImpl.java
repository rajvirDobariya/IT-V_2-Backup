...
public class DmsUploadServiceImpl implements DmsUploadService {
	...
	Logger logger = LoggerFactory.getLogger(DmsUploadServiceImpl.class);
	...
	public JSONObject dmsUpload(String applicationNo, String dsaCode) {
		...
		try {
			...
			obj = new URL(x.BASEURLV2 + "banking/7358/dms/upload?api_key=" + x.api_key);
			logger.debug("URL" + x.BASEURLV2 + "banking/7358/dms/upload?api_key=" + x.api_key);

...
@Component
public class DsaOnBoardFaceMatchController {
	@Autowired
	DsaOnboardFaceMatchService facematchservice;

	@RequestMapping(value = "/faceMatch", method = RequestMethod.POST, produces = "application/json")

...
public class TwowheelerPassportController {

	@Autowired
	TwowheelerPassportService passportservice;

	private static Logger logger = LoggerFactory.getLogger(TwowheelerPassportController.class);

	@PostMapping(value = "/verifyPassport", produces = "application/json")

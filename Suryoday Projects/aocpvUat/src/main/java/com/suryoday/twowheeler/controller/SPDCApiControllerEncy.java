...
public class SPDCApiControllerEncy {

	private static Logger logger = LoggerFactory.getLogger(SPDCApiControllerEncy.class);
	...
	@RequestMapping(value = "/spdcEncy", method = RequestMethod.POST, produces = "application/json")

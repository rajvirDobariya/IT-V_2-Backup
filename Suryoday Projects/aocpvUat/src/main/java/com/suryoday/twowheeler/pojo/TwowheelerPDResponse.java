...
public class TwowheelerPDResponse {
	...
	private EkycPoaResponse ekycResponse;
	...
	public EkycPoaResponse getEkycResponse() {
		return ekycResponse;
	}

	public void setEkycResponse(EkycPoaResponse ekycResponse) {

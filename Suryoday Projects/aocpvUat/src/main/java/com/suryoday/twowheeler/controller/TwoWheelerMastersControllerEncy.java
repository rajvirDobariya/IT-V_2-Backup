...
//			List<DealerByPincode> list = twowheelermastersservice.fetchDealerBypincode(pincode);
			...
			List<DealerByPincode> list = twowheelermastersservice
					.fetchAllDealer(twowheelerDetailesTable.getSalesBranchId(), manufacturer);
	...
	@RequestMapping(value = "/getBankCodeEncy", method = RequestMethod.POST, produces = "application/json")
	...
	@RequestMapping(value = "/fetchSchemeNtbEncy", method = RequestMethod.POST, produces = "application/json")
	public ResponseEntity<Object> fetchSchemeNtbEncy(@RequestBody String jsonRequest,
			@RequestHeader(name = "Content-Type", required = true) String Content_Type,
			@RequestHeader(name = "X-Request-ID", required = true) String X_Request_ID,
			@RequestHeader(name = "X-User-ID", required = true) String X_User_ID,
			@RequestHeader(name = "X-Session-ID", required = true) String X_Session_ID, HttpServletRequest request) {
	...
	@RequestMapping(value = "/fetchBySchemeNameNtbEncy", method = RequestMethod.POST)

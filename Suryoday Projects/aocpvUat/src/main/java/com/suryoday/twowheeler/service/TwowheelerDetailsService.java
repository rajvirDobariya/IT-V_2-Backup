...
public interface TwowheelerDetailsService {
	...
	List<TwowheelerResponse> fetchByDateAndbranch(LocalDateTime startdate, LocalDateTime enddate, String status,
	...
	String createApplicationNo(String mobileNo, String product, String branchId, String listType, String customerId,
			String x_User_ID);
	...
	List<TwowheelerResponse> fetchByDate(LocalDateTime startdate, LocalDateTime enddate, String assignTo);
	...
	List<TwowheelerResponse> fetchByDate(LocalDateTime startdate, LocalDateTime enddate, String status, String branchId,
			String assignTo);
	...
	List<TwowheelerResponse> getbyCustomerId(String cifNumber);

	UtilityBillResponse fetchUtilityBillDetails(String applicationNo, String flowStatus);

	List<NegativeLocalityMaster> getNegativeLocalityName();

	void updateAssignTo(List<String> list, String assignTo);

	JSONObject getDealSummary(String applicationNo);

	int fetchByLeadId(String lead_ID);

	NachDetailsResponse getNachDetails(String applicationNo);

	boolean validateCalculation(String totalOnRoadPrice, String marginMoney, String scheme, String amount,

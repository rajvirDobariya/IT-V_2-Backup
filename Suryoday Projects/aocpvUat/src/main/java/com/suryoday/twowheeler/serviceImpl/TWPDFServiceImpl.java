...
//			String payableAmount = String.valueOf(payableamount);
	...
	public String loanApplicationFormPdf(StringBuilder htmlString, String applicationNo) {
		Optional<TwowheelerDetailesTable> optional = twowheelerdetailsrepository.getByApplicationNo(applicationNo);
		TwowheelerDetailesTable twowheelerDetailesTable = optional.get();
		List<TwowheelerImage> list = twowheelerimagerepository.getByApplicationNoAndDocumentType(applicationNo,
				"customerPhoto");
...
//		String newDOb = dob.format(dateTimeFormatter);
		...
		htmlString.append(new String("<!DOCTYPE html>\r\n" + "<html>\r\n" + "    <head>\r\n" + "        <style>\r\n"
				...
				+ "            <p> Application Date: &nbsp;&nbsp;" + applicationDate
				+ "<span class=\"tab\" style=\"padding-left: 250px;\">Application Number:&nbsp;&nbsp;"
				+ twowheelerDetailesTable.getApplicationNo() + "</span></p>\r\n"
				+ "            <p> RM Code: &nbsp;&nbsp;xxxxx</p> \r\n"
				...
				+ " 'style=\"height: 140px; width: 125px;  margin-top: 5px;\">\r\n" + "                \r\n"
				+ "                </div> \r\n"
				+ "                <div class=\"img2\" style=\"height: 150px ; width: 33%; text-align: center; border: 1px solid black;\">\r\n"
				...
				+ dateOfBirth + "</td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
				+ "                    <td>Customer ID</td>\r\n" + "                    <td>"
				+ twowheelerDetailesTable.getCustomerId() + "</td>\r\n" + "                </tr>\r\n"
				+ "                <tr>\r\n" + "                    <td>PAN Number</td>\r\n"
				+ "                    <td>" + twowheelerDetailesTable.getPancard() + "</td>\r\n"
				+ "                </tr>\r\n" + "                <tr>\r\n"
				+ "                    <td>Voter ID number</td>\r\n" + "                    <td>"
				+ twowheelerDetailesTable.getVoterId() + "</td>\r\n" + "                </tr>\r\n"
				+ "                <tr>\r\n" + "                    <td>DL Number</td>\r\n"
				+ "                    <td></td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
				+ "                    <td>Gender</td>\r\n" + "                    <td>" + member.getGender()
				+ "</td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
				+ "                    <td>Marital Status</td>\r\n" + "                    <td>" + member.getMarried()
				+ "</td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
				+ "                    <td>Education:</td>\r\n" + "                    <td>" + member.getEducation()
				+ "</td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
				+ "                    <td>Occupation details:</td>\r\n" + "                    <td>"
				+ member.getOccupation() + "</td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
				+ "                    <td>Mobile Number:</td>\r\n" + "                    <td>"
				+ twowheelerDetailesTable.getMobileNo() + "</td>\r\n" + "                </tr>\r\n"
				+ "                <tr>\r\n" + "                    <td>Email ID:</td>\r\n"
				+ "                    <td></td>\r\n" + "                </tr>\r\n" + "            </table>\r\n"
				+ "            <table style=\"width: 98%;\">\r\n"
				...
				+ twowheelerDetailesTable.getAccountNumber() + "</td>\r\n" + "                </tr>\r\n"
				+ "                <tr>\r\n" + "                    <td>IFSC Code</td>\r\n" + "                    <td>"
				+ twowheelerDetailesTable.getAccountIfsc() + "</td>\r\n" + "                </tr>\r\n"
				...
				+ "                    <td style=\"width: 300px;\">" + twowheelerDetailesTable.getExShowroomPrice()
				+ "</td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
				...
				+ "                <tr>\r\n" + "                    <td>Accessories</td>\r\n"
				+ "                    <td style=\"width: 300px;\">" + twowheelerDetailesTable.getAccessories()
				+ "</td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
				+ "                    <td>Addon Charges </td>\r\n" + "                    <td>"
				+ twowheelerDetailesTable.getAddonsCharges() + "</td>\r\n" + "                </tr>\r\n"
				...
				+ "                <tr>\r\n" + "                    <td>Name</td>\r\n"
				+ "                    <td style=\"width: 300px;\">" + nominee.getFirstName() + " "
				+ nominee.getLastName() + "</td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
				+ "                    <td>DOB</td>\r\n" + "                    <td>" + nominee.getDob() + "</td>\r\n"
				+ "                </tr>\r\n" + "                <tr>\r\n" + "                    <td>Age</td>\r\n"
				+ "                    <td>" + nominee.getAge() + "</td>\r\n" + "                </tr>\r\n"
				+ "                <tr>\r\n" + "                    <td>Gender</td>\r\n" + "                    <td>"
				+ nominee.getGender() + "</td>\r\n" + "                </tr>\r\n" + "                <tr>\r\n"
...
//		LeegalityInfo leegalityInfo = listDB.get(0);
		if (optional.isPresent()) {
			TwowheelerDetailesTable twowheelerDetailesTable = optional.get();
			if (twowheelerDetailesTable.getEngineNumber() == null
					|| twowheelerDetailesTable.getEngineNumber().equals("")
					|| twowheelerDetailesTable.getChasisNumber() == null
					|| twowheelerDetailesTable.getChasisNumber().equals("")) {
				throw new EmptyInputException(
						"Please insert the Engine number and Chasis number before proceeding with Loan Agreement process.");
			}
			String address_Line1 = "";
			String address_Line2 = "";
			String address_Line3 = "";
			...
			htmlString.append(new String("<!doctype html>\r\n" + "<html class=\"h-full bg-white\">\r\n" + "	<head>\r\n"
					...
					+ "            <img style=\"width: 20%;\" src=\"" + x.LOGO + "logo.jpg\">\r\n" + "          </div>"
					+ " <h3 style=\"text-align: center;\">TWO-WHEELER LOAN AGREEMENT</h3>\r\n"
					...
					+ "				<b>Signature of Borrower</b>\r\n"
					+ "				<hr class=\"line-under-text\" >\r\n" + "			</div>\r\n"
					+ "<div style=\"margin:0 100px\">" + "				<b>Signature of Co-Applicant</b>\r\n"
					+ "				<hr class=\"line-under-text\">\r\n" + "			</div>\r\n" + "			<div>\r\n"
					+ "				<b>Signature of Authorized Signatory</b>\r\n"
					+ "				<hr class=\"line-under-text\">\r\n" + "			</div>\r\n" + "		</div>"
					...
					+ "				<td colspan=\"4\">This Agreement will come into effect from -" + todayDate
					+ " <br><br><br>Signature of Authorized Signatory</td>\r\n" + "			</tr>			\r\n"
					+ "		</table>\r\n"
					+ "		<p style=\"text-align: center; color: blue; margin-bottom: 0; font-size: 13px;\"> SURYODAY SMALL FINANCE BANK LIMITED</p>\r\n"
					+ "		<p style=\"color: blue; text-align: center; margin: 0; padding-top: 0;font-size: 12px;\"> Regd & Corp Offce : 1101, Sharda Terraces, Plot 65, Sector 11, CBD Belapur, Navi Mumbai-400614</p>\r\n"

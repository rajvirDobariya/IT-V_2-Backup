...
public class TWPDFController {
	...
	@Autowired
	CamReportService camReportService;

	Logger logger = LoggerFactory.getLogger(TWPDFController.class);

	@RequestMapping(value = "/sanctionLetter/downloadPdf", method = RequestMethod.POST, produces = "application/json")
...
//		twowheelerImageService.savepdf(inFileBytes,sanctionLetter1,applicationNo);
	...
	@RequestMapping(value = "/loanApplicationForm/downloadPdf", method = RequestMethod.POST, produces = "application/json")
	...
	@RequestMapping(value = "/loanAgreement/downloadPdf", method = RequestMethod.POST, produces = "application/json")
	public ResponseEntity<Object> downloanAgreementPdf(@RequestBody String jsonRequest,
			@RequestHeader(name = "X-Correlation-ID", required = true) String headerPersist,
			@RequestHeader(name = "X-From-ID", required = true) String X_From_ID,
			@RequestHeader(name = "X-To-ID", required = true) String X_To_ID,
			@RequestHeader(name = "X-Transaction-ID", required = true) String X_Transaction_ID,
...
//		twowheelerImageService.savepdf(inFileBytes,loanAgreement1,applicationNo);
	...
	@RequestMapping(value = "/camReport", method = RequestMethod.POST, produces = "application/json")
	public ResponseEntity<Object> camReport(@RequestBody String jsonRequest,
			@RequestHeader(name = "X-Correlation-ID", required = true) String headerPersist,
			@RequestHeader(name = "X-From-ID", required = true) String X_From_ID,
			@RequestHeader(name = "X-To-ID", required = true) String X_To_ID,
			@RequestHeader(name = "X-Transaction-ID", required = true) String X_Transaction_ID,
		...
		JSONObject jsonObj = camReportService.getcamReport(applicationNo);

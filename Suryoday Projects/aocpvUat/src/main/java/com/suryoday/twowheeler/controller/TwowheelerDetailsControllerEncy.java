...
public class TwowheelerDetailsControllerEncy {

	Logger logger = LoggerFactory.getLogger(TwowheelerDetailsControllerEncy.class);
...
//		 	   familyMember.setPancardNoVerify(pancardVerify);
			...
			familyMember.setNameMatchScore("80");
			familyMember.setNameMatch("YES");
			if (twowheelerDetails.getListType().equalsIgnoreCase("NEW")) {
...
//			}
//			 if(!document.isEmpty()) {
//				 twowheelerImageService.savePhoto(files,applicationNo,document,"TWPD");
//			 }
...
//									twowheelerUserLogService.saveUserLog(applicationNo,"SALES",X_User_ID,"OK","RO");
	...
	public ResponseEntity<Object> saveImageEncy(@RequestParam("file") MultipartFile[] files,
	...
	@RequestMapping(value = "/savefamilyDetailsEncy", method = RequestMethod.POST)
...
//		String dob = date.format(dateTimeFormatter);
	...
	@RequestMapping(value = "/saveAssetDetailsEncy", method = RequestMethod.POST)
...
//			 String branchId = jsonObject.getJSONObject("Data").getString("branchId");
	...
	@RequestMapping(value = "/saveLoanDetailsEncy", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/fetchFamilyDetailsEncy", method = RequestMethod.POST)
...
//			}
	...
	@RequestMapping(value = "/fetchByAppNoAndFlowStatusEncy", method = RequestMethod.POST)
	public ResponseEntity<Object> fetchByAppNoAndFlowStatus(@RequestBody String jsonRequest,
		...
		if (sessionId == true) {
			...
			if (flowStatus.equals("TWPD")) {
				...
				JSONObject j = new JSONObject(PDresponse);
				response.put("Data", j);
				...
				TwowheelerAssetDetailsResponse ASSETresponse = twowheelerDetailsService.fetchASSETData(applicationNo,
						flowStatus);
				JSONObject j = new JSONObject(ASSETresponse);
				response.put("Data", j);
			} else if (flowStatus.equals("TWUBC")) {
				UtilityBillResponse utilityBillResponse = twowheelerDetailsService
						.fetchUtilityBillDetails(applicationNo, flowStatus);
				JSONObject j = new JSONObject(utilityBillResponse);
				response.put("Data", j);
				...
				JSONObject j = new JSONObject(disbustmentDetails);
				response.put("Data", j);
				...
				if (twowheelerDetailesTable.getDudupeResponse() != null) {
					...
					String data = dudupeResponse.toString();
					String encryptString2 = AppzillonAESUtils.encryptStringtoContainer(data, key);
					org.json.simple.JSONObject data2 = new org.json.simple.JSONObject();
					data2.put("value", encryptString2);
					org.json.simple.JSONObject data3 = new org.json.simple.JSONObject();
				...
				BsrDetailsResponse bsrDetailsResponse = twowheelerDetailsService.fetchBsrDetails(applicationNo,
						flowStatus);
				JSONObject j = new JSONObject(bsrDetailsResponse);
				response.put("Data", j);
			} else if (flowStatus.equals("TWREF")) {
				TwowheelerDetailesTable twowheelerDetailesTable = twowheelerDetailsService
						.getByApplication(applicationNo);
				if (twowheelerDetailesTable.getReferenceInfo() != null) {
					org.json.JSONArray referenceInfo = new org.json.JSONArray(
							twowheelerDetailesTable.getReferenceInfo());
					String data = referenceInfo.toString();
					String encryptString2 = AppzillonAESUtils.encryptStringtoContainer(data, key);
					org.json.simple.JSONObject data2 = new org.json.simple.JSONObject();
					data2.put("value", encryptString2);
					org.json.simple.JSONObject data3 = new org.json.simple.JSONObject();
				...
				List<LeegalityInfo> list = leegalityService.getByApplicationNoAndDocument(applicationNo,
						"sanctionLetter");
				JSONArray j = new JSONArray(list);
				response.put("Data", j);
				...
				JSONObject j = new JSONObject(nachDetailsResponse);
				response.put("Data", j);
			}
			String data = response.toString();
			String encryptString2 = AppzillonAESUtils.encryptStringtoContainer(data, key);
	...
	public ResponseEntity<Object> fetchLoanDetailsEncy(@RequestBody String jsonRequest,
			@RequestHeader(name = "X-Correlation-ID", required = true) String headerPersist,
			@RequestHeader(name = "X-From-ID", required = true) String X_From_ID,
			@RequestHeader(name = "X-To-ID", required = true) String X_To_ID,
			@RequestHeader(name = "X-Transaction-ID", required = true) String X_Transaction_ID,
		...
		if (sessionId == true) {
			...
			String applicationNo = jsonObject.getJSONObject("Data").getString("ApplicationNo");
			String status = jsonObject.getJSONObject("Data").getString("Status");
			String consent = jsonObject.getJSONObject("Data").getString("Consent");
//		TwowheelerDetailesTable fetchLoanDetails = twowheelerDetailsService.fetchLoanDetails(applicationNo);
			if (status.equalsIgnoreCase("Initiated") && consent.equalsIgnoreCase("N")) {
				org.json.simple.JSONObject response = new org.json.simple.JSONObject();
				org.json.simple.JSONObject Data = new org.json.simple.JSONObject();
				Data.put("CRM", "Y");
				Data.put("LoanCreation", "Y");
				Data.put("CollateralDetails", "Y");
				Data.put("Disbursement", "N");
				Data.put("Imps", "N");
				...
				data3.put("Data", data2);
				return new ResponseEntity<Object>(data3, HttpStatus.OK);
			} else if (status.equalsIgnoreCase("ReInitiated") && consent.equalsIgnoreCase("Y")) {
				org.json.simple.JSONObject response = new org.json.simple.JSONObject();
				org.json.simple.JSONObject Data = new org.json.simple.JSONObject();
				Data.put("CRM", "Y");
				Data.put("LoanCreation", "Y");
				Data.put("CollateralDetails", "Y");
				Data.put("Disbursement", "Y");
				Data.put("Imps", "Y");
				response.put("Data", Data);
				String data = response.toString();
				String encryptString2 = AppzillonAESUtils.encryptStringtoContainer(data, key);
			...
			org.json.simple.JSONObject Data = new org.json.simple.JSONObject();
			Data.put("CRM", "N");
			Data.put("LoanCreation", "N");
			Data.put("CollateralDetails", "N");
			Data.put("Disbursement", "N");
			Data.put("Imps", "N");
			response.put("Data", Data);
			logger.debug(response.toString());
	...
	@RequestMapping(value = "/saveDisbustmentDetailsEncy", method = RequestMethod.POST)
...
//				}
	...
	@RequestMapping(value = "/checkMobileNoEncy", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/fetchRemarksEncy", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/getFamilyDetailsEncy", method = RequestMethod.POST)
	public ResponseEntity<Object> getFamilyDetails(@RequestBody String jsonRequest,
		...
		if (sessionId == true) {
			...
			List<TwoWheelerFamilyMemberResponse> fetchByApplicationNo = familyMemberService
					.getFamilyDetails(applicationNo);
			org.json.simple.JSONObject response = new org.json.simple.JSONObject();
			JSONArray j = new JSONArray(fetchByApplicationNo);
			response.put("status", HttpStatus.OK.toString());
			response.put("Data", j);
...
//				}
				...
				documentType = new ArrayList<>(Arrays.asList("Invoice", "AssetInsurance", "RTO", "DeliveryOrder",
...
//		 else {
			JSONArray j = new JSONArray(documentNotPresent);
			response.put("List", j);
//		 }
			logger.debug(response.toString());
			logger.debug("PD end");
			...
			if (twowheelerDetails.getStage().equalsIgnoreCase("SALES")) {
				...
				filteredList = list.stream()
						.filter(element -> !new ArrayList<>(Arrays.asList("Invoice", "AssetInsurance", "RTO",
								"DeliveryOrder", "MarginMoney", "CreditLifeInsurance", "EbBill", "Pan"))
								.contains(element))
						.collect(Collectors.toList());
			}
//		 if(twowheelerDetails.getListType().equalsIgnoreCase("NEW")) {
...
//			}
	...
	@RequestMapping(value = "/saveAdditionalInfoEncy", method = RequestMethod.POST)
...
//					nameInDouble=nameInDouble*100;
				familyMember.setNameMatch("YES");
				familyMember.setPenny_drop_name_match_score("80");
...
//			}	
	...
	@RequestMapping(value = "/getCatCompanyListEncy", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/saveBSRDetailsEncy", method = RequestMethod.POST)
	...
	public ResponseEntity<Object> getCheckList(@RequestBody String jsonRequest,
		...
		if (sessionId == true) {
			...
			org.json.simple.JSONObject response = new org.json.simple.JSONObject();
			JSONObject j = new JSONObject(checkList);
			response.put("Data", j);
			logger.debug(response.toString());
			String data = response.toString();
			String encryptString2 = AppzillonAESUtils.encryptStringtoContainer(data, key);
	...
	@RequestMapping(value = "/getNegativeLocalityNameEncy", method = RequestMethod.POST)
	public ResponseEntity<Object> getNegativeLocalityName(@RequestBody String jsonRequest,
		...
		if (sessionId == true) {
			...
			org.json.simple.JSONObject response = new org.json.simple.JSONObject();
			JSONArray j = new JSONArray(negativeLocalityMaster);
			response.put("Data", j);
			logger.debug(response.toString());
			String data = response.toString();
			String encryptString2 = AppzillonAESUtils.encryptStringtoContainer(data, key);
	...
	@RequestMapping(value = "/deleteImageEncy", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/getSanctionConditionEncy", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/saveSecurityPdcEncy", method = RequestMethod.POST)

...
public class TwowheelerAadharControllerEncy {
	...
	private static Logger logger = LoggerFactory.getLogger(TwowheelerAadharControllerEncy.class);
	...
	public ResponseEntity<Object> createAadharReference(@RequestBody String bm,
		...
		if (sessionId == true) {
			...
			if (X_Request_ID.equals("NOVOPAY")) {
				...
				// incomeDetailsService.fetchByAadharCard(AadharNumber);

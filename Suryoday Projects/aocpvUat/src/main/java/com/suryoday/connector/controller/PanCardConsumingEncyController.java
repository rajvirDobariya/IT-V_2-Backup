...
public class PanCardConsumingEncyController {
	...
	private static Logger logger = LoggerFactory.getLogger(PanCardConsumingEncyController.class);
			...
			if (X_Request_ID.equals("IEXCEED")) {
				...
				if (panCardValidate != null) {
					...
					if (Data1.has("Data")) {
						...
						incomeDetailsService.savePanResponse(responseResponse.toString(), applicationNo, member,
								isVerify, jsonRequest);
					}

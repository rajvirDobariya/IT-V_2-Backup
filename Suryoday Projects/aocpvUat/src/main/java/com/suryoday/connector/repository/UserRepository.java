...
public interface UserRepository extends JpaRepository<User, String> {
	...
	@Query(value = "select allow_credit_access from tbl_user where user_id =:userId", nativeQuery = true)
	...
	// @Query(value = "select SESSION_PRIMARY_ID from SPRING_SESSION_ATTRIBUTES
	// where ATTRIBUTE_NAME =:userID1", nativeQuery = true)

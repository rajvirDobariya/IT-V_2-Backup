...
public class GoNoGoPancardControllerEncy {
	...
	private static Logger logger = LoggerFactory.getLogger(GoNoGoPancardControllerEncy.class);
				...
				if (panCardValidate != null) {
					...
					if (Data1.has("Data")) {
						...
						if (panStatus.equals("Record (PAN) Not Found in ITD Database/Invalid PAN")) {
							...
							goNogoCustDetailsService.saveResponse("panCard", panCardNo, applicationNo,
									jsonArray1.toString());
							if (count == 1) {

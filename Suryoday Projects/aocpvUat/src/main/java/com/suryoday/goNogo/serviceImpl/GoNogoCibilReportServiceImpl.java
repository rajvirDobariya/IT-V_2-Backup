...
@Service
public class GoNogoCibilReportServiceImpl implements GoNogoCibilReportService {

	private static Logger logger = LoggerFactory.getLogger(GoNogoCibilReportServiceImpl.class);

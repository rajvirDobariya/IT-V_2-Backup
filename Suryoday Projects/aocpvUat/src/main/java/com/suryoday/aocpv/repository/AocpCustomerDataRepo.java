...
public interface AocpCustomerDataRepo extends JpaRepository<AocpCustomer, Long> {
	...
	// @Query(value = "SELECT a from AocpCustomer a where a.branchid =:branchId and
	// a.mobileNo =:mobile")
	...
	// @Query(value ="SELECT * from aocp_table a where a.status =:s order by
	// a.updatedate desc",nativeQuery = true)
	// List<AocpCustomer> findByDateAndBranchId(LocalDate startdate, LocalDate
	// enddate, String branchId);
	...
	List<AocpCustomer> findByDateAndBranchID(@Param("s") LocalDate startdate, @Param("e") LocalDate enddate,
			String branch);
	...
	List<AocpCustomer> findByDateAndStatus(@Param("s") LocalDate startdate, @Param("e") LocalDate enddate,
			String status);
	...
	List<AocpCustomer> findByDateStatusAndBranchId(@Param("s") LocalDate startdate, @Param("e") LocalDate enddate,
	...
	List<AocpCustomer> findByDateAndBranchIdWeb(@Param("s") LocalDate startdate, @Param("e") LocalDate enddate,
			String branchId);

	@Procedure("usp_Fetch_By_Date")
	List<Object[]> getRetriveReportData(@Param("Start_Date") String startDate, @Param("End_Date") String endDate,
			@Param("status") String status, @Param("state") String state, @Param("city") String city,

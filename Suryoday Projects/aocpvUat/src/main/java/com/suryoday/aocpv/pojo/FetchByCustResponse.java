...
public class FetchByCustResponse {
	...
	public FetchByCustResponse(long applicationNo, long customerID, String memberName, long mobilePhone,
			String branchId, String status, String createDate, String updateDate, String appNoWithProductCode) {
		super();
		this.applicationNo = applicationNo;
		this.customerID = customerID;
		this.memberName = memberName;

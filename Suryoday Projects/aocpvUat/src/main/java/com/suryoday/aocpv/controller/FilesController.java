...
public class FilesController {
	...
	public ResponseEntity<List<ResponseFile>> getListFiles() {
		...
		List<ResponseFile> allfiles = new ArrayList<ResponseFile>();
		...
		for (Iterator<FileDB> name = files.iterator(); name.hasNext();) {
			...
			FileDB dbFile = (FileDB) name.next();
...
//	    
//	        System.out.println("Files elements : ");  
//	    
//	        while (iterator.hasNext())  
//	        {
//	        	   System.out.print(iterator.next() + " ");  
//	        	   FileDB dbFile= (FileDB) iterator.next();
//	        	   System.out.println(dbFile.getId());
//	        	   System.out.println(dbFile.getName());

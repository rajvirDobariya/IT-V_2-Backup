...
public class IncomeDetailWeb {
	...
	private VoterIdResponse voterIdResponse;
	private PanCardResponseNew panCardResponseNew;
	...
	public PanCardResponseNew getPanCardResponseNew() {
		return panCardResponseNew;
	}

	public void setPanCardResponseNew(PanCardResponseNew panCardResponseNew) {
		this.panCardResponseNew = panCardResponseNew;
	}

	public VoterIdResponse getVoterIdResponse() {
		return voterIdResponse;
	}

	public void setVoterIdResponse(VoterIdResponse voterIdResponse) {
		this.voterIdResponse = voterIdResponse;
	}

	public PanCardResponse getPanCardResponse() {
		return panCardResponse;
	}

	public void setPanCardResponse(PanCardResponse panCardResponse) {
	...
	public String toString() {
		return "IncomeDetailWeb [member=" + member + ", earning=" + earning + ", occupation=" + occupation
				+ ", occCode=" + occCode + ", primarySourceOfIncome=" + primarySourceOfIncome + ", securedLoan="
				+ securedLoan + ", unsecuredLoan=" + unsecuredLoan + ", monthlyIncome=" + monthlyIncome
				+ ", monthlyLoanEmi=" + monthlyLoanEmi + ", title=" + title + ", firstName=" + firstName + ", lastName="
				+ lastName + ", gender=" + gender + ", age=" + age + ", dob=" + dob + ", mobile=" + mobile
				+ ", married=" + married + ", aadharCard=" + aadharCard + ", panCard=" + panCard + ", aadharNoVerify="
				+ aadharNoVerify + ", pancardNoVerify=" + pancardNoVerify + ", mobileVerify=" + mobileVerify
				+ ", voterId=" + voterId + ", voterIdVerify=" + voterIdVerify + ", image=" + image + "]";
	}

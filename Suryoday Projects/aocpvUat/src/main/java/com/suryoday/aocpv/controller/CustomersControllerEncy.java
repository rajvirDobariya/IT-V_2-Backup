...
public class CustomersControllerEncy {

	Logger logger = LoggerFactory.getLogger(CustomersControllerEncy.class);
	...
	@RequestMapping(value = "/getDataency", method = RequestMethod.POST, produces = "application/json")
	public ResponseEntity<Object> getCustomerData(@RequestBody String bm,
		...
		if (sessionId == true) {
			...
			if (X_REQUEST_ID.equals("IBR")) {
				...
				JSONObject response = customerService.getData(jsonObject, Header);
				// hardcode Response Start
//			 
//			 org.json.simple.JSONObject   response2= new org.json.simple.JSONObject();
//			 response2.put("CIFNUMBER", "230001116");
//			 response2.put("CUSTOMERTYPE","R");
//			 response2.put("BRANCHCODE","50601");
...
//				 JSONObject jsonObject3 = jsonObject2.getJSONObject("Data");
					if (Data1.has("Data")) {
						...
						if (jsonObject.getJSONObject("Data").getString("CustomerNo").equals("230001116")) {
							object.put("REGISTEREDMOBILE", "9987447004");
							object.put("AADHAR_NUMBER", "594957550563");
							object.put("PAN_NUMBER", "IIZPK2842F");
						} else if (jsonObject.getJSONObject("Data").getString("CustomerNo").equals("220160978")) {
							object.put("REGISTEREDMOBILE", "9987447004");
							object.put("AADHAR_NUMBER", "594957550563");
							object.put("PAN_NUMBER", "IIZPK2842F");
						} else {
					...
					org.json.simple.JSONObject data6 = new org.json.simple.JSONObject();
					data6.put("value", encryptString2);
					org.json.simple.JSONObject data8 = new org.json.simple.JSONObject();
					data8.put("Data", data6);
					// System.out.println(data8);
					return new ResponseEntity<Object>(data8, h);

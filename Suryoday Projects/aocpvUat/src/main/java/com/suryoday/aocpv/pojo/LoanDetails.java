...
//			private int RETAIL_VINTAGE;
	...
	public String toString() {
		return "LoanDetails [referenceNo=" + referenceNo + ", memberName=" + memberName + ", state=" + state
				+ ", mobilePhone=" + mobilePhone + ", numOpenAccount=" + numOpenAccount + ", sumOutstandingBalance="
				+ sumOutstandingBalance + ", sumOutstandingBalanceOwn=" + sumOutstandingBalanceOwn
				+ ", sumInstallmentAmountopen=" + sumInstallmentAmountopen + ", latestCloseDate=" + latestCloseDate
				+ ", MFI_VINTAGE=" + MFI_VINTAGE + ", MFI_VINTAGE_SSFB=" + MFI_VINTAGE_SSFB + ", MFI_BUREAU_VINTAGE="
				+ MFI_BUREAU_VINTAGE + ", MAX_MFI_EMI=" + MAX_MFI_EMI + ", MAX_LOAN_AMOUNT_MFI=" + MAX_LOAN_AMOUNT_MFI
				...
				+ ", RETAIL_IMPUTED_EMI_WO_CCOD_CURRENT=" + RETAIL_IMPUTED_EMI_WO_CCOD_CURRENT + ", NUM_SECURED_ACCTS="
				+ NUM_SECURED_ACCTS + ", NUM_UNSECURED_ACCTS=" + NUM_UNSECURED_ACCTS + ", RETAIL_BUREAU_VINTAGE="
				+ RETAIL_BUREAU_VINTAGE + ", MAX_CURRENT_EMI=" + MAX_CURRENT_EMI + ", NUM_SECURED_CLOSED_ACCTS="
				+ NUM_SECURED_CLOSED_ACCTS + ", NUM_UNSECURED_CLOSED_ACCTS=" + NUM_UNSECURED_CLOSED_ACCTS
				+ ", NUM_SECURED_LIVE_ACCTS=" + NUM_SECURED_LIVE_ACCTS + ", NUM_UNSECURED_LIVE_ACCTS="
				+ NUM_UNSECURED_LIVE_ACCTS + ", NUM_PL_LIVE=" + NUM_PL_LIVE + ", NUM_PL_CLOSED=" + NUM_PL_CLOSED
				+ ", NUM_BL_LIVE=" + NUM_BL_LIVE + ", NUM_BL_CLOSED=" + NUM_BL_CLOSED + ", NUM_HL_LAP_LIVE="
				+ NUM_HL_LAP_LIVE + ", NUM_HL_LAP_CLOSED=" + NUM_HL_LAP_CLOSED + ", LATEST_ACCOUNTSTATUS_PL="
				+ LATEST_ACCOUNTSTATUS_PL + ", LATEST_ACCOUNTSTATUS_BL=" + LATEST_ACCOUNTSTATUS_BL
				+ ", LATEST_ACCOUNTSTATUS_HL_LAP=" + LATEST_ACCOUNTSTATUS_HL_LAP + ", TOTAL_DISB_PL=" + TOTAL_DISB_PL
				+ ", TOTAL_DISB_BL=" + TOTAL_DISB_BL + ", TOTAL_DISB_HL_LAP=" + TOTAL_DISB_HL_LAP + ", BL_POS=" + BL_POS
				+ ", PL_POS=" + PL_POS + ", BUREAU_VINTAGE_PL=" + BUREAU_VINTAGE_PL + ", BUREAU_VINTAGE_BL="
				+ BUREAU_VINTAGE_BL + ", BUREAU_VINTAGE_HL_LAP=" + BUREAU_VINTAGE_HL_LAP + ", LATEST_CLOSEDATE_PL="
				+ LATEST_CLOSEDATE_PL + ", LATEST_CLOSEDATE_BL=" + LATEST_CLOSEDATE_BL + ", LATEST_CLOSEDATE_HL_LAP="
				+ LATEST_CLOSEDATE_HL_LAP + ", LATEST_CLOSEDATE_SECURED=" + LATEST_CLOSEDATE_SECURED
				+ ", LATEST_CLOSEDATE_UNSECURED=" + LATEST_CLOSEDATE_UNSECURED + ", MAX_EMI_PL=" + MAX_EMI_PL
				+ ", MAX_EMI_BL=" + MAX_EMI_BL + ", MAX_EMI_SECURED=" + MAX_EMI_SECURED + ", MAX_EMI_UNSECURED="
				+ MAX_EMI_UNSECURED + ", MAX_EMI_HL_LAP=" + MAX_EMI_HL_LAP + ", MAX_LOAN_TENURE_HL_LAP="
				+ MAX_LOAN_TENURE_HL_LAP + ", MAX_LOAN_TENURE_PL=" + MAX_LOAN_TENURE_PL + ", MAX_LOAN_TENURE_BL="
				+ MAX_LOAN_TENURE_BL + ", MAX_LOAN_TENURE_SECURED=" + MAX_LOAN_TENURE_SECURED
				+ ", MAX_LOAN_TENURE_UNSECURED=" + MAX_LOAN_TENURE_UNSECURED + ", MAX_LOAN_AMOUNT_UNSECURED="
				+ MAX_LOAN_AMOUNT_UNSECURED + ", MAX_LOAN_AMOUNT_SECURED=" + MAX_LOAN_AMOUNT_SECURED
				+ ", MAX_LOAN_AMOUNT_PL=" + MAX_LOAN_AMOUNT_PL + ", MAX_LOAN_AMOUNT_BL=" + MAX_LOAN_AMOUNT_BL
				+ ", MAX_LOAN_AMOUNT_HL_LAP=" + MAX_LOAN_AMOUNT_HL_LAP + ", branchId=" + branchId + ", amount=" + amount
				+ ", status=" + status + ", createDate=" + createDate + ", updatedate=" + updatedate + ", customerID="
				+ customerID + ", AccountNo=" + AccountNo + ", ELIGIBLE_LOAN_VALUE_2YEARS=" + ELIGIBLE_LOAN_VALUE_2YEARS
				+ ", DisbursedAmt=" + DisbursedAmt + ", SSFB_DPD_BUCKETS=" + SSFB_DPD_BUCKETS + ", TOTAL_NUM_MFI_ACCTS="
				+ TOTAL_NUM_MFI_ACCTS + ", NUM_HL_LAP_ACCTS=" + NUM_HL_LAP_ACCTS + ", NUM_BL_ACCTS=" + NUM_BL_ACCTS
				+ ", NUM_PL_ACCTS=" + NUM_PL_ACCTS + ", NUM_CLOSED_ACCTS=" + NUM_CLOSED_ACCTS
				+ ", LATEST_ACCOUNTSTATUS_SECURED=" + LATEST_ACCOUNTSTATUS_SECURED + ", LATEST_ACCOUNTSTATUS_UNSECURED="
				+ LATEST_ACCOUNTSTATUS_UNSECURED + ", TOTAL_MFI_DISBURSEMENT=" + TOTAL_MFI_DISBURSEMENT
				+ ", TOTAL_DISB_SECURED=" + TOTAL_DISB_SECURED + ", TOTAL_DISB_UNSECURED=" + TOTAL_DISB_UNSECURED
				+ ", BUREAU_VINTAGE_SECURED=" + BUREAU_VINTAGE_SECURED + ", BUREAU_VINTAGE_UNSECURED="
				+ BUREAU_VINTAGE_UNSECURED + ", Current_CycleNo=" + Current_CycleNo + ", Branch_Name=" + Branch_Name
				+ ", CITY=" + CITY + ", DISTRICT_NAME=" + DISTRICT_NAME + ", CentreName=" + CentreName + ", BranchCode="
				+ BranchCode + "]";
	}

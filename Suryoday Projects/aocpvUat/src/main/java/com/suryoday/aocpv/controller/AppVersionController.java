...
//							return new ResponseEntity<Object>(Data, HttpStatus.BAD_REQUEST);
					throw new NoSuchElementException("Please Upgrade Application");
				}
...
//				
	...
	public ResponseEntity<Object> tabres(@RequestHeader(name = "X-Bearer-ID", required = true) String Bearer,

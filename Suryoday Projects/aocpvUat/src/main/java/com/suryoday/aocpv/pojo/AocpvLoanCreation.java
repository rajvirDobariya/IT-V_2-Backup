...
public class AocpvLoanCreation {
	...
	private String IsBrNetImageUpload;
	...
	public String getIsBrNetImageUpload() {
		return IsBrNetImageUpload;
	}

	public void setIsBrNetImageUpload(String isBrNetImageUpload) {
		IsBrNetImageUpload = isBrNetImageUpload;
	}

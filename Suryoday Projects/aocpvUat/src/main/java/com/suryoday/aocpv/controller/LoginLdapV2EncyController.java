...
public class LoginLdapV2EncyController {
	...
	public ResponseEntity<Object> login(@RequestBody String bm, HttpServletRequest request,
		...
		String deviceToken = jm.getString("DeviceToken");

		boolean checkDevice = service.checkDevice(userId, deviceId, deviceToken);
		if (checkDevice == true) {
...
//			
				...
				// ldapContext.getJSONObject("data").getString("TransactionCode").toString();
				String serviceStatus = "00";
				...
				if (serviceStatus.equals("00")) {
					...
					System.out.println("dto" + dtos.toString());
...
//			
			...
			data1.put("code", HttpStatus.BAD_REQUEST);
			data1.put("message", "Device is Already Mapped with another User");
			Data.put("Error", data1);
			return new ResponseEntity<Object>(Data.toString(), HttpStatus.BAD_REQUEST);

...
public class DateUtils {
	...
	public static LocalDate getDateStringIntoLocalDate(String dateString) {
		...
		try {
			...
			throw new LoanException("Please enter date in YYYY-mm-DD format!");
		}
	}
	...
	public static LocalDate getLoanDisbursementDate(String dateStr) {
	    List<DateTimeFormatter> formatters = Arrays.asList(
	        new DateTimeFormatterBuilder()
	            .parseCaseInsensitive()
	            .appendPattern("dd-MMM-yy")
	            .toFormatter(Locale.ENGLISH),
	        DateTimeFormatter.ISO_LOCAL_DATE_TIME, // Handles ISO date-time format (e.g., 2017-03-31T00:00:00)
	        DateTimeFormatter.ISO_LOCAL_DATE // Handles ISO date format (e.g., 2017-03-31)
	    );

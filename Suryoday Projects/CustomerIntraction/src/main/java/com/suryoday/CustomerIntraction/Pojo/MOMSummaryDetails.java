...
@Entity
@Table(name="MOM_summary_details")
public class MOMSummaryDetails {
	...
	public String toString() {
		return "MOMSummaryDetails [meetingId=" + meetingId + ", meetingNumber=" + meetingNumber + ", topicOfDiscussion="
				+ topicOfDiscussion + ", branchActionable=" + branchActionable + ", feedback=" + feedback + ", ETA="
				+ ETA + ", createdDate=" + createdDate + ", updatedDate=" + updatedDate + ", createdBy=" + createdBy
				+ ", updatedBy=" + updatedBy + ", role=" + role + "]";
	}

package com.suryodaybank.enduse.exception;
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(EndUseException.class)
	public ResponseEntity<String> handleTravelVisitException(EndUseException ex) {
